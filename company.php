...
<head>
  ...
  <title>Particleworks Europe - company</title>
...
<!-- === SEO head (auto-generated, matches backup website_now) === -->
  <link rel="canonical" href="https://particleworks-europe.com/company.html">
  ...
  <meta property="og:title" content="Particleworks Europe - company">
  ...
  <meta property="og:url" content="https://particleworks-europe.com/company.html">
  <meta property="og:type" content="website">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Particleworks Europe - company">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        <ul class="navbar-nav align-items-lg-center gap-1">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
              <li><a class="dropdown-item active" href="company.html"><i class="bi bi-building"></i><span><div class="dd-t">About Particleworks Europe</div><div class="dd-s">Who we are</div></span></a></li>
    ...
    <!-- company banner title -->
      <section class="main_section background-green" >
          <div class="container">
              <div class="row">
                  <div class="col-12">
                      <h1 class="display-6 text-end text-uppercase text-white pt-2">Company</h1>
                  </div></div></div>
              </section>
   ...
   <!-- company  -->
    ...
    <div class="row d-flex featurette align-items-center">         
      <div class="col-md-8 pb-4">
        ...
        <p class="lead">Particleworks Europe is a Joint Venture between Prometech Software Inc. and EnginSoft S.p.A. </p>
          <p class="text-justify">The JV aims to establish, promote and manage the European distribution of Particleworks and of Granuleworks.</p>
 <p class="text-justify">In addition to and to supporting and enhancing this network, Particleworks Europe will also more specifically constitute the European competence center for these technologies, both to support distributors and to assist customers.
</p>
 <p class="text-justify">Particleworks Europe will also aggregate the needs and requirements of target customers to ensure their rational inclusion in the development roadmap of the related software technologies</p>
      </div>     
    <div class="col-md-3"><div id="mission"></div>
<img src="images/ES-Prometech.png" alt="EnginSoft and Promotech" class="img-fluid mx-auto shadow">
        </div>
   ...
   <div class="row d-flex align-items-center py-4">
        <div class="col-md-4">
       <h2 class="text-muted">MISSION</h2>          
      </div>
            <div class="col-md-8 pt-5">
                <p class="text-justify">Particleworks Europe aims to establish and manage the <strong>European distribution network</strong> of the software technologies <strong>Particleworks and Granuleworks </strong>based on the Moving Particle Simulation (MPS). <br> Particleworks Europe is the European <strong>competence center</strong> for these technologies</p>
            </div>
                 </div>
                     <div class="row d-flex featurette align-items-center">  
        <div class="col-md-4">
       <h2 class="text-muted">VISION</h2>          
      </div>
            <div class="col-md-8 pt-5"> <div id="team"></div>
               <p class="text-justify">We deliver <strong>high quality support</strong> to distributors and customers for the industrial application of <strong>advanced simulation techniques. </strong></p>
            </div>       
      ...
      <section class="mt-4 py-4 text-center container-fluid background_gray">
    <div class="row">
      <div class="col-lg-6 col-md-8 mx-auto">
        <h2 class="featurette-heading mt-4 mb-0">The team</h2>
        </div>
    </div>
  </section>
           
      
      <section class="py-1 text-center background_gray">
          <div class="container">
              
              
              <div class="row row-cols-1 row-cols-md-1 row-cols-lg-1 row-cols-xl-3 g-4 mb-3">
  <div class="col">
    <div class="card">
      <div class="card-body">
        <div class="d-flex align-items-center">
          <img
            src="images/team/MassimoGalbiati.png"
            alt="Massimo Galbiati"
            class="img-fluid rounded-circle border-gray mx-3"
          />
          <div class="ms-1">
             <h5 class="text-start">Massimo Galbiati</h5>
          <p class="small text-muted text-start">Co-founder and CEO <br>of Particleworks Europe</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card">
      <div class="card-body">
        <div class="d-flex align-items-center">
          <img
            src="images/team/HenningBrandes.png"
            alt="Henning Brandes"
            class="img-fluid rounded-circle border-gray mx-3"
          />
          <div class="ms-1">
             <h5 class="text-start">Henning Brandes</h5>
          <p class="small text-muted text-start">Sales manager and Marketing</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="col">
    <div class="card">
      <div class="card-body">
        <div class="d-flex align-items-center">
          <img
            src="images/team/JonasLindgren.png"
            alt="Jonas Lindgren"
            class="img-fluid rounded-circle border-gray mx-3"
          />
          <div class="ms-1">
             <h5 class="text-start">Jonas Lindgren </h5>
          <p class="small text-muted text-start">Sales Northern Europe</p>
          </div>
        </div>
      </div>
    </div>
