...
<head>
  ...
  <title>Case Studies: engines and pistons - Particleworks Europe</title>
  <meta name="description" content="Simulation of moving particles: discover the case studies of engines and pistons. Visit our website and check out insights, application and much more!">
  ...
  <style>
    :root {
      ...
      --pw-gray: #6c757d;
      --pw-light: #f8f9fa;
      --hero-accent: linear-gradient(135deg, #2c1810 0%, #8b4513 40%, #cc6600 100%);
    }
    * { font-family: 'Inter', sans-serif; }
    ...
    .app-hero::after { content: ''; position: absolute; inset: 0; background: linear-gradient(180deg, rgba(20,10,0,0.55) 0%, rgba(20,10,0,0.85) 100%); }
    .app-hero .container { position: relative; z-index: 2; }
    .app-hero .badge-industry { display: inline-flex; align-items: center; gap: 0.4rem; background: rgba(204,102,0,0.3); color: #fff; border: 1px solid rgba(204,102,0,0.5); padding: 0.3rem 0.9rem; border-radius: 50px; font-size: 0.78rem; font-weight: 700; letter-spacing: 0.5px; text-transform: uppercase; margin-bottom: 1.2rem; }
...
<!-- === SEO head (auto-generated, matches backup website_now) === -->
  <link rel="canonical" href="https://particleworks-europe.com/engines-and-pistons.html">
  ...
  <meta property="og:title" content="Case Studies: engines and pistons - Particleworks Europe">
  <meta property="og:description" content="Simulation of moving particles: discover the case studies of engines and pistons. Visit our website and check out insights, application and much more!">
  <meta property="og:url" content="https://particleworks-europe.com/engines-and-pistons.html">
  <meta property="og:type" content="website">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Case Studies: engines and pistons - Particleworks Europe">
  <meta name="twitter:description" content="Simulation of moving particles: discover the case studies of engines and pistons. Visit our website and check out insights, application and much more!">
  <!-- Iubenda -->
...
<!-- End Google Tag Manager (noscript) -->
        ...
        <ul class="navbar-nav align-items-lg-center gap-1">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
              ...
              <li><a class="dropdown-item active" href="engines-and-pistons.html"><i class="bi bi-fuel-pump"></i><span><div class="dd-t">Engines &amp; Pistons</div><div class="dd-s">Combustion thermal</div></span></a></li>
  ...
  <section class="app-body">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-10">
          ...
          <p>Piston cooling plays a critical role in modern engines. The intense heat generated during combustion threatens structural integrity. Lightweight aluminum alloys exhibit strength reduction at elevated temperatures. Oil jets strategically target critical areas ensuring uniform temperature distribution.</p>

          <p>Particleworks enables engineers to simulate the transient oil jet impingement on reciprocating pistons, capturing the complex interaction between moving geometry, oil film formation, and heat extraction. The meshfree approach naturally handles the large deformations and splashing that make traditional mesh-based methods impractical for this application.</p>

          <figure class="app-figure"><img src="images/case-studies/engines-pistons.webp" alt="Piston cooling jets and oil splash in internal combustion engines" loading="lazy"><figcaption>Piston cooling jets and oil splash in internal combustion engines</figcaption></figure>
          ...
          <div class="row g-3 mb-4">
            <div class="col-md-4 col-sm-6">
              <div class="cap-card">
                ...
                <h6>Jet nozzle design improvements</h6>
              </div>
            </div>
            <div class="col-md-4 col-sm-6">
              <div class="cap-card">
                <div class="cap-icon"><i class="bi bi-speedometer2"></i></div>
                <h6>Flowrate/direction impact on cooling</h6>
              </div>
            </div>
            <div class="col-md-4 col-sm-6">
              <div class="cap-card">
                <div class="cap-icon"><i class="bi bi-wind"></i></div>
                <h6>Air drag effects on oil distribution</h6>
              </div>
            </div>
            <div class="col-md-4 col-sm-6">
              <div class="cap-card">
                <div class="cap-icon"><i class="bi bi-water"></i></div>
                <h6>Sloshing influence on cooling</h6>
              </div>
            </div>
            <div class="col-md-4 col-sm-6">
              <div class="cap-card">
                <div class="cap-icon"><i class="bi bi-thermometer-half"></i></div>
                <h6>Piston design modifications for higher HTC</h6>
              </div>
            </div>
          </div>
          ...
          <div class="row g-4 mb-4">
            <div class="col-lg-6">
              <div class="video-wrap">
                <iframe src="https://www.youtube.com/embed/zfKaUdy0egc?autoplay=1&mute=1&loop=1&playlist=zfKaUdy0egc&controls=0&showinfo=0" title="Piston cooling jet simulation" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="video-wrap">
                <iframe src="https://www.youtube.com/embed/4ElOUXURYUQ?autoplay=1&mute=1&loop=1&playlist=4ElOUXURYUQ&controls=0&showinfo=0" title="Engine oil gallery simulation" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="video-wrap">
                <iframe src="https://www.youtube.com/embed/24AbjTx5x7E?autoplay=1&mute=1&loop=1&playlist=24AbjTx5x7E&controls=0&showinfo=0" title="Piston thermal management" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
            </div>
          </div>
          ...
          <div class="row g-3">
            <div class="col-md-4">
              <a href="cases/ducati.html" class="case-card">
                <h5>Ducati</h5>
                <span class="card-arrow"><i class="bi bi-arrow-right"></i></span>
              </a>
            </div>
            <div class="col-md-4">
              <a href="cases/hitachi.html" class="case-card">
                <h5>Hitachi</h5>
                <span class="card-arrow"><i class="bi bi-arrow-right"></i></span>
              </a>
            </div>
            <div class="col-md-4">
              <a href="cases/hpe.html" class="case-card">
                <h5>HPE</h5>
                <span class="card-arrow"><i class="bi bi-arrow-right"></i></span>
              </a>
            </div>
            <div class="col-md-4">
              <a href="cases/royal-enfield.html" class="case-card">
                <h5>Royal Enfield</h5>
                <span class="card-arrow"><i class="bi bi-arrow-right"></i></span>
              </a>
            </div>
            <div class="col-md-4">
              <a href="cases/wfinland.html" class="case-card">
                <h5>W Finland</h5>
                <span class="card-arrow"><i class="bi bi-arrow-right"></i></span>
              </a>
            </div>
    ...
    <div class="container">
      ...
      <div class="row g-3">
            ...
            <div class="col-lg-4 col-md-6">
              <a href="engines-and-pistons.html" class="app-tile current">
            ...
            <div class="col-lg-4 col-md-6">
              <a href="sterilization-food-and-consumer-goods.html" class="app-tile">
  ...
  <section class="cta-section">
    <div class="container text-center">
      ...
      <p style="color:var(--pw-gray); max-width:520px; margin:0 auto 1.5rem; font-size:1.05rem;">Request a personalized demo to explore piston cooling and engine thermal simulation.</p>
