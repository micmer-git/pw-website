...
<head>
  ...
  <title>Case Studies: clutches and brakes - Particleworks Europe</title>
  <meta name="description" content="Simulation of moving particles: discover the case studies of clutches and brakes. Visit our website and check out insights, application and much more!">
  ...
  <style>
    :root {
      ...
      --pw-gray: #6c757d;
      --pw-light: #f8f9fa;
      --hero-accent: linear-gradient(135deg, #3e2723 0%, #5d4037 50%, #795548 100%);
    }
    * { font-family: 'Inter', sans-serif; }
    ...
    .app-hero::after { content: ''; position: absolute; inset: 0; background: linear-gradient(180deg, rgba(62,39,35,0.55) 0%, rgba(62,39,35,0.85) 100%); }
    .app-hero .container { position: relative; z-index: 2; }
    .app-hero .badge-industry { display: inline-flex; align-items: center; gap: 0.4rem; background: rgba(121,85,72,0.4); color: #fff; border: 1px solid rgba(121,85,72,0.6); padding: 0.3rem 0.9rem; border-radius: 50px; font-size: 0.78rem; font-weight: 700; letter-spacing: 0.5px; text-transform: uppercase; margin-bottom: 1.2rem; }
...
<!-- === SEO head (auto-generated, matches backup website_now) === -->
  <link rel="canonical" href="https://particleworks-europe.com/clutches-and-brakes.html">
  ...
  <meta property="og:title" content="Case Studies: clutches and brakes - Particleworks Europe">
  <meta property="og:description" content="Simulation of moving particles: discover the case studies of clutches and brakes. Visit our website and check out insights, application and much more!">
  <meta property="og:url" content="https://particleworks-europe.com/clutches-and-brakes.html">
  <meta property="og:type" content="website">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Case Studies: clutches and brakes - Particleworks Europe">
  <meta name="twitter:description" content="Simulation of moving particles: discover the case studies of clutches and brakes. Visit our website and check out insights, application and much more!">
  <!-- Iubenda -->
...
<!-- End Google Tag Manager (noscript) -->
        ...
        <ul class="navbar-nav align-items-lg-center gap-1">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
              ...
              <li><a class="dropdown-item active" href="clutches-and-brakes.html"><i class="bi bi-disc"></i><span><div class="dd-t">Clutches &amp; Brakes</div><div class="dd-s">Disc cooling flows</div></span></a></li>
  ...
  <section class="app-body">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-10">
          ...
          <p>Advanced performance demands require innovative solutions for heat generation and wear management. Wet clutches and brakes operate in extreme thermal environments where oil flow between plates directly determines component life and shift quality.</p>

          <p>Particleworks allows engineers to simulate the thin-film oil flow between rotating clutch plates, predict heat transfer coefficients across complex plate geometries, and evaluate how different operating conditions affect temperature distribution. The meshfree method naturally handles the narrow gaps and high-speed rotation that characterize these applications.</p>

          <figure class="app-figure"><img src="images/case-studies/clutches-brakes.webp" alt="Oil and coolant flow analysis in clutch and brake systems" loading="lazy"><figcaption>Oil and coolant flow analysis in clutch and brake systems</figcaption></figure>
          ...
          <div class="row g-3 mb-4">
            <div class="col-md-4 col-sm-6">
              <div class="cap-card">
                ...
                <h6>Oil flow between clutch plates</h6>
              </div>
            </div>
            <div class="col-md-4 col-sm-6">
              <div class="cap-card">
                <div class="cap-icon"><i class="bi bi-diagram-3"></i></div>
                <h6>Flow distribution in channels</h6>
              </div>
            </div>
            <div class="col-md-4 col-sm-6">
              <div class="cap-card">
            ...
            <div class="col-md-4 col-sm-6">
              <div class="cap-card">
                <div class="cap-icon"><i class="bi bi-sliders"></i></div>
                <h6>Working condition influence</h6>
              </div>
            </div>
            <div class="col-md-4 col-sm-6">
              <div class="cap-card">
                <div class="cap-icon"><i class="bi bi-thermometer-sun"></i></div>
                <h6>Temperature prediction in disks</h6>
              </div>
            </div>
          </div>
          ...
          <div class="row g-4 mb-4">
            <div class="col-lg-6">
              <div class="video-wrap">
                <iframe src="https://www.youtube.com/embed/PKV9PtOmlQw?autoplay=1&mute=1&loop=1&playlist=PKV9PtOmlQw&controls=0&showinfo=0" title="Clutch oil flow simulation" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="video-wrap">
                <iframe src="https://www.youtube.com/embed/cDVa-orPISY?autoplay=1&mute=1&loop=1&playlist=cDVa-orPISY&controls=0&showinfo=0" title="Brake thermal simulation" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
            </div>
          </div>
    ...
    <div class="container">
      ...
      <div class="row g-3">
            ...
            <div class="col-lg-4 col-md-6">
              <a href="clutches-and-brakes.html" class="app-tile current">
  ...
  <section class="cta-section">
    <div class="container text-center">
      ...
      <p style="color:var(--pw-gray); max-width:520px; margin:0 auto 1.5rem; font-size:1.05rem;">Request a personalized demo to explore clutch and brake thermal simulation.</p>
