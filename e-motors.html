...
<head>
  ...
  <title>Case Studies: E-motors - Particleworks Europe</title>
  <meta name="description" content="Simulation of moving particles: discover the case studies of E-motors. Visit our website and check out insights, application and much more!">
  ...
  <style>
    :root {
      ...
      --pw-gray: #6c757d;
      --pw-light: #f8f9fa;
      --hero-accent: linear-gradient(135deg, #0d2137 0%, #1565c0 50%, #00897b 100%);
    }
    * { font-family: 'Inter', sans-serif; }
    ...
    .app-hero::after { content: ''; position: absolute; inset: 0; background: linear-gradient(180deg, rgba(0,15,30,0.55) 0%, rgba(0,15,30,0.85) 100%); }
    .app-hero .container { position: relative; z-index: 2; }
    .app-hero .badge-industry { display: inline-flex; align-items: center; gap: 0.4rem; background: rgba(21,101,192,0.3); color: #fff; border: 1px solid rgba(21,101,192,0.5); padding: 0.3rem 0.9rem; border-radius: 50px; font-size: 0.78rem; font-weight: 700; letter-spacing: 0.5px; text-transform: uppercase; margin-bottom: 1.2rem; }
...
<!-- === SEO head (auto-generated, matches backup website_now) === -->
  <link rel="canonical" href="https://particleworks-europe.com/e-motors.html">
  ...
  <meta property="og:title" content="Case Studies: E-motors - Particleworks Europe">
  <meta property="og:description" content="Simulation of moving particles: discover the case studies of E-motors. Visit our website and check out insights, application and much more!">
  <meta property="og:url" content="https://particleworks-europe.com/e-motors.html">
  <meta property="og:type" content="website">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Case Studies: E-motors - Particleworks Europe">
  <meta name="twitter:description" content="Simulation of moving particles: discover the case studies of E-motors. Visit our website and check out insights, application and much more!">
  <!-- Iubenda -->
...
<!-- End Google Tag Manager (noscript) -->
        ...
        <ul class="navbar-nav align-items-lg-center gap-1">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
              <li><a class="dropdown-item active" href="e-motors.html"><i class="bi bi-lightning-charge"></i><span><div class="dd-t">E-Motors</div><div class="dd-s">Oil-cooled electric drives</div></span></a></li>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-10">
          ...
          <p>E-motor design faces a critical challenge: escalating power densities. Traditional water-cooling methods fall short. Oil-cooled e-motors are the innovative solution. Managing end-winding temperatures, preventing hotspots and magnet demagnetization, avoiding airgap contamination are key challenges.</p>

          <p>Particleworks provides the unique ability to simulate oil distribution inside electric motors at full transient resolution. Engineers can evaluate spray nozzle configurations, drip-feed systems, and direct oil cooling approaches to find optimal thermal management strategies for next-generation electric powertrains.</p>

          <figure class="app-figure"><img src="images/case-studies/e-motors.webp" alt="Oil cooling and thermal management in electric motor windings" loading="lazy"><figcaption>Oil cooling and thermal management in electric motor windings</figcaption></figure>
          ...
          <div class="row g-3 mb-4">
            <div class="col-md-4 col-sm-6">
              <div class="cap-card">
                ...
                <h6>Cooling of windings/stator/magnets (HTC maps)</h6>
              </div>
            </div>
            <div class="col-md-4 col-sm-6">
              <div class="cap-card">
                <div class="cap-icon"><i class="bi bi-diagram-3"></i></div>
                <h6>Coolant flow split</h6>
              </div>
            </div>
            <div class="col-md-4 col-sm-6">
              <div class="cap-card">
                <div class="cap-icon"><i class="bi bi-wind"></i></div>
                <h6>Air drag/windage effects</h6>
              </div>
            </div>
            <div class="col-md-4 col-sm-6">
              <div class="cap-card">
                <div class="cap-icon"><i class="bi bi-exclamation-triangle"></i></div>
                <h6>Airgap contamination</h6>
              </div>
            </div>
            <div class="col-md-4 col-sm-6">
              <div class="cap-card">
                <div class="cap-icon"><i class="bi bi-broadcast"></i></div>
                <h6>Temperature distribution with electromagnetic losses</h6>
              </div>
            </div>
          </div>
          ...
          <div class="row g-4 mb-4">
            <div class="col-lg-6">
              <div class="video-wrap">
                <iframe src="https://www.youtube.com/embed/YdeYxAy8D5E?autoplay=1&mute=1&loop=1&playlist=YdeYxAy8D5E&controls=0&showinfo=0" title="E-motor oil cooling simulation" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="video-wrap">
                <iframe src="https://www.youtube.com/embed/X0_2yEOmYK0?autoplay=1&mute=1&loop=1&playlist=X0_2yEOmYK0&controls=0&showinfo=0" title="Electric drive cooling" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="video-wrap">
                <iframe src="https://www.youtube.com/embed/HJATgZ6FppE?autoplay=1&mute=1&loop=1&playlist=HJATgZ6FppE&controls=0&showinfo=0" title="E-motor thermal management" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
            </div>
          </div>
          ...
          <div class="row g-3">
            <div class="col-md-4">
              <a href="cases/emotors.html" class="case-card">
                <h5>E-Motors</h5>
                <span class="card-arrow"><i class="bi bi-arrow-right"></i></span>
              </a>
            </div>
            <div class="col-md-4">
              <a href="cases/drive-system-design.html" class="case-card">
                <h5>Drive System Design</h5>
                <span class="card-arrow"><i class="bi bi-arrow-right"></i></span>
              </a>
            </div>
            <div class="col-md-4">
              <a href="cases/iav.html" class="case-card">
                <h5>IAV</h5>
                <span class="card-arrow"><i class="bi bi-arrow-right"></i></span>
              </a>
            </div>
            <div class="col-md-4">
              <a href="cases/ricardo.html" class="case-card">
                <h5>Ricardo</h5>
                <span class="card-arrow"><i class="bi bi-arrow-right"></i></span>
              </a>
            </div>
            <div class="col-md-4">
              <a href="cases/total-energies.html" class="case-card">
                <h5>TotalEnergies</h5>
                <span class="card-arrow"><i class="bi bi-arrow-right"></i></span>
              </a>
            </div>
    ...
    <div class="container">
      ...
      <div class="row g-3">
            <div class="col-lg-4 col-md-6">
              <a href="e-motors.html" class="app-tile current">
  ...
  <section class="cta-section">
    <div class="container text-center">
      ...
      <p style="color:var(--pw-gray); max-width:520px; margin:0 auto 1.5rem; font-size:1.05rem;">Request a personalized demo to explore e-motor oil cooling and thermal simulation.</p>
