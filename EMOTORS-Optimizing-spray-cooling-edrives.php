...
<head>
  ...
  <meta name="description" content="Case study: Optimizing the spray cooling of e-drives with moving particle simulation">
...
<!-- === SEO head (auto-generated, matches backup website_now) === -->
  <link rel="canonical" href="https://particleworks-europe.com/EMOTORS-Optimizing-spray-cooling-edrives.html">
  ...
  <meta property="og:description" content="Case study: Optimizing the spray cooling of e-drives with moving particle simulation">
  <meta property="og:url" content="https://particleworks-europe.com/EMOTORS-Optimizing-spray-cooling-edrives.html">
  <meta property="og:type" content="website">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Moving Particle Simulation: the case studies of Particleworks Europe">
  <meta name="twitter:description" content="Case study: Optimizing the spray cooling of e-drives with moving particle simulation">
  <!-- Iubenda -->
...
<!-- End Google Tag Manager (noscript) -->
  ...
  <section class="case-hero">
    <div class="container">
      ...
      <h1>Optimizing the spray cooling of e-drives with moving particle simulation</h1>
      <div class="case-meta">
        <strong><i class="bi bi-people me-1"></i> Ioan Deac &amp; Juan Wang (EMOTORS), Michele Merelli (EnginSoft)</strong>
        <span class="mx-2">|</span>
        <span><i class="bi bi-building me-1"></i> EMOTORS</span>
      </div>
    </div>
  </section>
      ...
      <div class="row g-5">
        <div class="col-lg-8">
          <div class="case-image">
            <img src="images/case-studies/emotors-enginsoft.png" alt="Optimizing the spray cooling of e-drives with moving particle simulation">
          </div>
          <h3 class="fw-bold mb-3">Abstract</h3>
          <p class="abstract-text">This paper describes the simulation of e-motor cooling using MPS, a mesh-less approach well-suited to impinging jet and free-surface flow analyses. We reported the methodology, internal flow rate split, windage effects, HTC distribution, and temperature distribution.</p>
        </div>
        <div class="col-lg-4">
          <div class="sidebar-card mb-4">
            ...
            <div class="d-flex align-items-center mb-3">
              ...
              <div>
                ...
                <span class="fw-medium">EMOTORS</span>
              </div>
            </div>
            <div class="d-flex align-items-center mb-3">
              ...
              <div class="d-flex align-items-center mb-3">
                ...
                <div>
                  ...
                  <span class="fw-medium">Futurities Year 19 n&deg;1</span>
                </div>
              </div>
            <div class="d-flex align-items-center mb-3">
          ...
          <div class="sidebar-card">
            ...
            <div class="d-grid gap-2">
              ...
              <a href="https://particleworks-europe.forms-eu.com/embed.php?id=12127" class="btn btn-pw-green me-3 mb-2" target="_blank">
