...
<head>
  ...
  <title>Meshfree methods: the consulting service of Particleworks Europe</title>
  <meta name="description" content="Meshfree methods: discover all the set of solutions to help your engineering team overcome the challenges of everyday life. See our website and contact us!">
...
<!-- === SEO head (auto-generated, matches backup website_now) === -->
  <link rel="canonical" href="https://particleworks-europe.com/consulting.html">
  ...
  <meta property="og:title" content="Meshfree methods: the consulting service of Particleworks Europe">
  <meta property="og:description" content="Meshfree methods: discover all the set of solutions to help your engineering team overcome the challenges of everyday life. See our website and contact us!">
  <meta property="og:url" content="https://particleworks-europe.com/consulting.html">
  <meta property="og:type" content="website">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Meshfree methods: the consulting service of Particleworks Europe">
  <meta name="twitter:description" content="Meshfree methods: discover all the set of solutions to help your engineering team overcome the challenges of everyday life. See our website and contact us!">
        ...
        <ul class="navbar-nav align-items-lg-center gap-1">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
              ...
              <li><a class="dropdown-item active" href="consulting.html"><i class="bi bi-briefcase"></i><span><div class="dd-t">Consulting &amp; Services</div><div class="dd-s">Engineering support</div></span></a></li>
            </ul>
          </li>
  ...
  <main>
    <!-- company banner title -->
      <section class="main_section background-green">
          <div class="container">
              <div class="row">
                  <div class="col-12">
                      <h1 class="display-6 text-end text-uppercase text-white pt-2">Consulting</h1>
                  </div></div></div>
              </section>
   ...
   <!-- consulting  -->      
      ...
      <div class="col-md-7 pb-4 pe-4">
        <h2 class="featurette-heading">We will guide you <span class="text-muted">in selecting the most appropriate consulting service </span></h2>
        <p class="lead pt-4">Whether it is a guidance on the most efficient use of software, a comprehensive assessment of your current simulation processes with a roadmap for improvement or complete installation, configuration, deployment and optimization of enterprise-wide simulation software, Particleworks Europe offers a set of solutions to help your engineering team overcome the challenges of everyday life.</p>
          <p class="lead">We will guide you in selecting the most appropriate consulting service that best meets your unique needs. <br>
 Contact us to find out how our team can help you find the ideal solutions to optimize processes, reduce operating costs and increase the competitiveness of your products in the market. We can help you with simulation workflow improvement, process compression and customization for greater solution flexibility.</p>
          <div class="p-3 background_gray my-auto d-block">
          <p>For information about consulting or professional services, please</p>
              <a href="contact.html" class="btn btn-primary text-uppercase"> Contact us</a></div>
      </div>     
    <div class="col-md-5">  
         <img src="images/PW_consulting.png" class="img-fluid rounded-circle box-icon-green bg-white float-end my-3">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="images/PW_consulting03.png" class="d-block w-100" alt="Particleworks Europe offers a set of solutions">
    </div>
    <div class="carousel-item">
       <img src="images/PW_consulting02.png" class="d-block w-100" alt="The ideal solutions to optimize processes">
    </div>
    <div class="carousel-item">
      <img src="images/PW_consulting01.png" class="d-block w-100" alt="Simulation workflow improvement">
    </div>
  </div> 
</div>
