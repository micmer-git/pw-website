...
<head>
  ...
  <meta name="description" content="Case study: Free Flow Coolant Simulation in Electric Motors using Moving Particle Semi-Implicit (MPS) Method">
...
<!-- === SEO head (auto-generated, matches backup website_now) === -->
  <link rel="canonical" href="https://particleworks-europe.com/IAV-edrivecooling.html">
  ...
  <meta property="og:description" content="Case study: Free Flow Coolant Simulation in Electric Motors using Moving Particle Semi-Implicit (MPS) Method">
  <meta property="og:url" content="https://particleworks-europe.com/IAV-edrivecooling.html">
  <meta property="og:type" content="website">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Moving Particle Simulation: the case studies of Particleworks Europe">
  <meta name="twitter:description" content="Case study: Free Flow Coolant Simulation in Electric Motors using Moving Particle Semi-Implicit (MPS) Method">
  <!-- Iubenda -->
...
<!-- End Google Tag Manager (noscript) -->
  ...
  <section class="case-hero">
    <div class="container">
      ...
      <h1>Free Flow Coolant Simulation in Electric Motors using MPS Method</h1>
      <div class="case-meta">
        <strong><i class="bi bi-people me-1"></i> Sebastian Jugelt, IAV GmbH</strong>
        <span class="mx-2">|</span>
        <span><i class="bi bi-building me-1"></i> IAV GmbH</span>
      </div>
    </div>
  </section>
      ...
      <div class="row g-5">
        <div class="col-lg-8">
          <div class="case-image">
            <img src="images/case-studies/IAV_01.png" alt="Free Flow Coolant Simulation in Electric Motors using MPS Method">
          </div>
          <h3 class="fw-bold mb-3">Abstract</h3>
          <p class="abstract-text">A new simulation technique using MPS method for coolant flow in electric motors. Allows better prediction of free surface flow, spray, jet impingement and calculation of local heat transfer coefficients. Used by IAV during early design iterations.</p>
        </div>
        <div class="col-lg-4">
          <div class="sidebar-card mb-4">
            ...
            <div class="d-flex align-items-center mb-3">
              ...
              <div>
                ...
                <span class="fw-medium">IAV GmbH</span>
              </div>
            </div>
            <div class="d-flex align-items-center mb-3">
          ...
          <div class="sidebar-card">
            ...
            <div class="d-grid gap-2">
              ...
              <p class="text-muted small mb-0">Contact us for the full paper.</p>
              <a href="mailto:info@particleworks-europe.com" class="btn btn-pw-outline">
