...
<head>
  ...
  <title>Technical Support for Particleworks software- Particleworks Europe</title>
  <meta name="description" content="Discover the variety of technical support to help you realize the potential of Particleworks software. Contact us and we will support you need to do your job!">
...
<!-- === SEO head (auto-generated, matches backup website_now) === -->
  <link rel="canonical" href="https://particleworks-europe.com/support.html">
  ...
  <meta property="og:title" content="Technical Support for Particleworks software- Particleworks Europe">
  <meta property="og:description" content="Discover the variety of technical support to help you realize the potential of Particleworks software. Contact us and we will support you need to do your job!">
  <meta property="og:url" content="https://particleworks-europe.com/support.html">
  <meta property="og:type" content="website">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Technical Support for Particleworks software- Particleworks Europe">
  <meta name="twitter:description" content="Discover the variety of technical support to help you realize the potential of Particleworks software. Contact us and we will support you need to do your job!">
        ...
        <ul class="navbar-nav align-items-lg-center gap-1">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a class="dropdown-item active" href="support.html"><i class="bi bi-life-preserver"></i><span><div class="dd-t">Support</div><div class="dd-s">Technical help</div></span></a></li>
            </ul>
          </li>
          <li class="nav-item dropdown">
  ...
  <main>
    <!-- company banner title -->
      <section class="main_section background-blue">
          <div class="container">
              <div class="row">
                  <div class="col-12">
                      <h1 class="display-6 text-end text-uppercase text-white pt-2">Technical Support</h1>
                  </div></div></div>
              </section>
   ...
   <!-- support  -->      
      ...
      <div class="col-md-7 pb-4 pe-4">
        <h2 class="featurette-heading">Our commitment to quality <span class="text-muted">is evident </span></h2>
        <p class="lead pt-4">Whether you are new to engineering simulation or are a highly-skilled specialist, Particleworks Europe provides the training, consulting services and support you need to do your job.</p>
         <p class="lead">Live phone support and the <a href="contact.html" class="underline">Contact Form</a> are ways for you to submit requests.
From software customization and process compression, to technical support and training, our services are designed to address the unique needs of your organization, so you have access to resources when and where you need them (and in the form that is most useful to your team).</p>
            <div class="p-3 background_gray my-auto d-block">
          <p>For information about our technical support or our services, please</p>
              <a href="contact.html" class="btn btn-primary text-uppercase"> Contact us</a></div>
      </div>     
    <div class="col-md-5">  
         <img src="images/PW_support.png" class="img-fluid rounded-circle box-icon-blue bg-white float-end my-3">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="images/PW_consulting03.png" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
       <img src="images/PW_consulting02.png" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="images/PW_consulting01.png" class="d-block w-100" alt="...">
    </div>
  </div> 
</div>
