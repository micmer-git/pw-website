...
<head>
  ...
  <title>Case Studies: vehicle management - Particleworks Europe</title>
  <meta name="description" content="Simulation of moving particles: discover the case studies of vehicle management. Visit our website and check out insights, application and much more!">
  ...
  <style>
    :root {
      ...
      --pw-gray: #6c757d;
      --pw-light: #f8f9fa;
      --hero-accent: linear-gradient(135deg, #0d47a1 0%, #1565c0 50%, #1976d2 100%);
    }
    * { font-family: 'Inter', sans-serif; }
    ...
    .app-hero::after { content: ''; position: absolute; inset: 0; background: linear-gradient(180deg, rgba(13,71,161,0.55) 0%, rgba(13,71,161,0.85) 100%); }
    .app-hero .container { position: relative; z-index: 2; }
    .app-hero .badge-industry { display: inline-flex; align-items: center; gap: 0.4rem; background: rgba(25,118,210,0.35); color: #fff; border: 1px solid rgba(25,118,210,0.6); padding: 0.3rem 0.9rem; border-radius: 50px; font-size: 0.78rem; font-weight: 700; letter-spacing: 0.5px; text-transform: uppercase; margin-bottom: 1.2rem; }
...
<!-- === SEO head (auto-generated, matches backup website_now) === -->
  <link rel="canonical" href="https://particleworks-europe.com/vehicle-management.html">
  ...
  <meta property="og:title" content="Case Studies: vehicle management - Particleworks Europe">
  <meta property="og:description" content="Simulation of moving particles: discover the case studies of vehicle management. Visit our website and check out insights, application and much more!">
  <meta property="og:url" content="https://particleworks-europe.com/vehicle-management.html">
  <meta property="og:type" content="website">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Case Studies: vehicle management - Particleworks Europe">
  <meta name="twitter:description" content="Simulation of moving particles: discover the case studies of vehicle management. Visit our website and check out insights, application and much more!">
  <!-- Iubenda -->
...
<!-- End Google Tag Manager (noscript) -->
        ...
        <ul class="navbar-nav align-items-lg-center gap-1">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
              ...
              <li><a class="dropdown-item active" href="vehicle-management.html"><i class="bi bi-truck"></i><span><div class="dd-t">Vehicle Management</div><div class="dd-s">Onboard fluid systems</div></span></a></li>
  ...
  <section class="app-body">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-10">
          ...
          <p>Simulation for vehicle management dealing with environmental interactions -- water intake on flooded roads, wading contamination with mud and snow, aquaplaning prevention. These are critical safety scenarios that must be validated before physical prototyping.</p>

          <p>Particleworks uniquely captures the violent, chaotic fluid behavior that vehicles encounter in real-world conditions. From deep water crossings that risk engine flooding, to high-speed aquaplaning where tyre tread design determines grip, to impact forces on battery enclosures from road debris -- the meshfree particle method handles these extreme free-surface flows with exceptional fidelity.</p>

          <figure class="app-figure"><img src="images/case-studies/vehicle-management.webp" alt="Fluid management and thermal behaviour of onboard vehicle systems" loading="lazy"><figcaption>Fluid management and thermal behaviour of onboard vehicle systems</figcaption></figure>
          ...
          <div class="row g-3 mb-4">
            <div class="col-md-4 col-sm-6">
              <div class="cap-card">
                ...
                <h6>Water intake in flooded roads</h6>
              </div>
            </div>
            <div class="col-md-4 col-sm-6">
              <div class="cap-card">
                <div class="cap-icon"><i class="bi bi-cloud-rain"></i></div>
                <h6>Wading contamination</h6>
              </div>
            </div>
            <div class="col-md-4 col-sm-6">
              <div class="cap-card">
                <div class="cap-icon"><i class="bi bi-circle"></i></div>
                <h6>Tyre tread effects</h6>
              </div>
            </div>
            <div class="col-md-4 col-sm-6">
              <div class="cap-card">
                <div class="cap-icon"><i class="bi bi-battery-charging"></i></div>
                <h6>Impact forces on battery cases</h6>
              </div>
            </div>
            <div class="col-md-4 col-sm-6">
              <div class="cap-card">
                <div class="cap-icon"><i class="bi bi-shield-check"></i></div>
                <h6>Aquaplaning prevention</h6>
              </div>
            </div>
          </div>
          ...
          <div class="row g-4 mb-4">
            <div class="col-lg-6">
              <div class="video-wrap">
                <iframe src="https://www.youtube.com/embed/z5vzk_adalk?autoplay=1&mute=1&loop=1&playlist=z5vzk_adalk&controls=0&showinfo=0" title="Vehicle wading simulation" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="video-wrap">
                <iframe src="https://www.youtube.com/embed/KG4pSL1eBaI?autoplay=1&mute=1&loop=1&playlist=KG4pSL1eBaI&controls=0&showinfo=0" title="Aquaplaning simulation" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="video-wrap">
                <iframe src="https://www.youtube.com/embed/bupr60k_4qg?autoplay=1&mute=1&loop=1&playlist=bupr60k_4qg&controls=0&showinfo=0" title="Vehicle environmental simulation" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
            </div>
          </div>
    ...
    <div class="container">
      ...
      <div class="row g-3">
            ...
            <div class="col-lg-4 col-md-6">
              <a href="vehicle-management.html" class="app-tile current">
  ...
  <section class="cta-section">
    <div class="container text-center">
      ...
      <p style="color:var(--pw-gray); max-width:520px; margin:0 auto 1.5rem; font-size:1.05rem;">Request a personalized demo to explore vehicle wading and aquaplaning simulation.</p>
