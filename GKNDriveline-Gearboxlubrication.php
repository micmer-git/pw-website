...
<head>
  ...
  <meta name="description" content="Case study: Gearbox lubrication studies with meshless CFD methods">
...
<!-- === SEO head (auto-generated, matches backup website_now) === -->
  <link rel="canonical" href="https://particleworks-europe.com/GKNDriveline-Gearboxlubrication.html">
  ...
  <meta property="og:description" content="Case study: Gearbox lubrication studies with meshless CFD methods">
  <meta property="og:url" content="https://particleworks-europe.com/GKNDriveline-Gearboxlubrication.html">
  <meta property="og:type" content="website">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Moving Particle Simulation: the case studies of Particleworks Europe">
  <meta name="twitter:description" content="Case study: Gearbox lubrication studies with meshless CFD methods">
  <!-- Iubenda -->
...
<!-- End Google Tag Manager (noscript) -->
  ...
  <section class="case-hero">
    <div class="container">
      ...
      <h1>Gearbox lubrication studies with meshless CFD methods</h1>
      <div class="case-meta">
        <strong><i class="bi bi-people me-1"></i> Henning Dombrowski, GKN Driveline</strong>
        <span class="mx-2">|</span>
        <span><i class="bi bi-building me-1"></i> GKN Driveline</span>
      </div>
    </div>
  </section>
      ...
      <div class="row g-5">
        <div class="col-lg-8">
          <div class="case-image">
            <img src="images/case-studies/HenningDombrowski_02.png" alt="Gearbox lubrication studies with meshless CFD methods">
          </div>
          <h3 class="fw-bold mb-3">Abstract</h3>
          <p class="abstract-text">GKN Driveline produces gearbox systems for AWD, hybrid and electric vehicles. Complex moving geometries led to using meshless CFD methods (SPH and MPS) for rapid concept development and oil flow understanding.</p>
        </div>
        <div class="col-lg-4">
          <div class="sidebar-card mb-4">
            ...
            <div class="d-flex align-items-center mb-3">
              ...
              <div>
                ...
                <span class="fw-medium">GKN Driveline</span>
              </div>
            </div>
            <div class="d-flex align-items-center mb-3">
          ...
          <div class="sidebar-card">
            ...
            <div class="d-grid gap-2">
              <a href="images/case-studies/CAE2018_GKN_Driveline_MPS_SPH.pdf" class="btn btn-pw me-3 mb-2" target="_blank">
