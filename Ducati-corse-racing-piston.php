...
<head>
  ...
  <meta name="description" content="Case study: Estimation of cycle average convective heat transfer coefficient on the underside of a racing piston for different layouts of oil jets">
...
<!-- === SEO head (auto-generated, matches backup website_now) === -->
  <link rel="canonical" href="https://particleworks-europe.com/Ducati-corse-racing-piston.html">
  ...
  <meta property="og:description" content="Case study: Estimation of cycle average convective heat transfer coefficient on the underside of a racing piston for different layouts of oil jets">
  <meta property="og:url" content="https://particleworks-europe.com/Ducati-corse-racing-piston.html">
  <meta property="og:type" content="website">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Moving Particle Simulation: the case studies of Particleworks Europe">
  <meta name="twitter:description" content="Case study: Estimation of cycle average convective heat transfer coefficient on the underside of a racing piston for different layouts of oil jets">
  <!-- Iubenda -->
...
<!-- End Google Tag Manager (noscript) -->
  ...
  <section class="case-hero">
    <div class="container">
      <div class="industry-badge"><i class="bi-gear-wide-connected"></i> Engines & Pistons</div>
      <h1>Estimation of cycle average convective heat transfer coefficient on the underside of a racing piston for different layouts of oil jets</h1>
      <div class="case-meta">
        <strong><i class="bi bi-people me-1"></i> Gaspare Argento, Ducati Motor Holding - Ducati Corse Division</strong>
        <span class="mx-2">|</span>
        <span><i class="bi bi-building me-1"></i> Ducati Motor Holding</span>
      </div>
    </div>
  </section>
      ...
      <div class="row g-5">
        <div class="col-lg-8">
          <div class="case-image">
            <img src="images/case-studies/ducaticorse_img01.png" alt="Estimation of cycle average convective heat transfer coefficient on the underside of a racing piston for different layouts of oil jets">
          </div>
          <h3 class="fw-bold mb-3">Abstract</h3>
          <p class="abstract-text">Oil jets are widely used in high performance and racing engines in order to prevent the piston from overheating and protecting the engine from serious damage. The oil flowing across the underside of the piston helps cooling off the component, so the heat is transferred to the oil. Typically, the oil is sprayed from a nozzle installed at the bottom of the cylinder. Depending on the number, diameter and location of the nozzle's holes the resulting heat transfer performance will be different. The main goal of this work was to find an alternative nozzle layout having a lower oil flow rate but with the same heat transfer performance. Three geometries, different from the reference one for number of holes, diameters and trajectories, have been studied. Their performance was assessed based on the cycle average convective heat transfer coefficient values on the underside of the piston. All simulations were performed using the commercial mesh-free CFD software Particle Works.</p>
        </div>
        <div class="col-lg-4">
          <div class="sidebar-card mb-4">
            ...
            <div class="d-flex align-items-center mb-3">
              ...
              <div>
                ...
                <span class="fw-medium">Ducati Motor Holding</span>
              </div>
            </div>
            <div class="d-flex align-items-center mb-3">
              <div class="info-icon"><i class="bi-gear-wide-connected"></i></div>
              <div>
                <small class="text-muted d-block">Industry</small>
                <span class="fw-medium">Engines & Pistons</span>
              </div>
            </div>
            <div class="d-flex align-items-center mb-3">
          ...
          <div class="sidebar-card">
            ...
            <div class="d-grid gap-2">
              ...
              <a href="https://particleworks-europe.forms-eu.com/embed.php?id=14379" class="btn btn-pw-green me-3 mb-2" target="_blank">
                <i class="bi bi-download me-2"></i>Request Full Paper
              </a>
            </div>
          </div>
        </div>
