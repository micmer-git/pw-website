...
<head>
  ...
  <meta name="description" content="Don't hesitate to get in touch if you are interested in working with Particleworks Europe">
...
<!-- === SEO head (auto-generated, matches backup website_now) === -->
  <link rel="canonical" href="https://particleworks-europe.com/careers.html">
  ...
  <meta property="og:description" content="Don't hesitate to get in touch if you are interested in working with Particleworks Europe">
  <meta property="og:url" content="https://particleworks-europe.com/careers.html">
  <meta property="og:type" content="website">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Particleworks Europe - company">
  <meta name="twitter:description" content="Don't hesitate to get in touch if you are interested in working with Particleworks Europe">
        ...
        <ul class="navbar-nav align-items-lg-center gap-1">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
              ...
              <li><a class="dropdown-item active" href="careers.html"><i class="bi bi-person-plus"></i><span><div class="dd-t">Careers</div><div class="dd-s">Join the team</div></span></a></li>
  ...
  <main>
    <!-- company banner title -->
      <section class="main_section background-blue">
          <div class="container">
              <div class="row">
                  <div class="col-12">
                      <h1 class="display-6 text-end text-uppercase text-white pt-2">Careers</h1>
                  </div></div></div>
              </section>
   ...
   <!-- careers  -->    
          ...
          <div class="container">
              <div class="row">
                  <div class="col-12">
                      <h2 class="featurette-heading pb-4">Careers <span class="text-muted"></span></h2>
                  </div></div></div>
              </section>
...
<div class="col-md-12">          
        <p class="lead text-muted">
            Particleworks Europe is the European distributor of the innovative simulation software packages Particleworks and Granuleworks.</p>
 <p class="lead text-muted">We are a young, flat and flexible organization that listens to our customers to understand their needs. <br>
     We then propose high quality solutions to improve their products and processes.</p>
 <p class="lead text-muted">We are always looking for new ways to apply our software and competencies.<br>
We are customer driven, prefer long-term relationships and are growing fast.</p>
    </div></div></div></section>
...
<p class="lead">
Don't hesitate to get in touch if you are interested in working with Particleworks Europe: submit your spontaneously application! </p>
<p class="lead">We look forward to receiving your detailed application at <a href="mailto:hr@particleworks-europe.com" class="underline">hr@particleworks-europe.com</a></p>
