...
<head>
  ...
  <meta name="description" content="Case study: Visualization of Oil Lubrication in the Transfer Case and the Transmission using Particleworks - Oil has various important roles in lubrication, cooling, buffering and air tightness, whereas it causes torque loss for its flow resistance">
...
<!-- === SEO head (auto-generated, matches backup website_now) === -->
  <link rel="canonical" href="https://particleworks-europe.com/Univance-ChainLubrication.html">
  ...
  <meta property="og:description" content="Case study: Visualization of Oil Lubrication in the Transfer Case and the Transmission using Particleworks - Oil has various important roles in lubrication, cooling, buffering and air tightness, whereas it causes torque loss for its flow resistance">
  <meta property="og:url" content="https://particleworks-europe.com/Univance-ChainLubrication.html">
  <meta property="og:type" content="website">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Moving Particle Simulation: the case studies of Particleworks Europe">
  <meta name="twitter:description" content="Case study: Visualization of Oil Lubrication in the Transfer Case and the Transmission using Particleworks - Oil has various important roles in lubrication, cooling, buffering and air tightness, whereas it causes torque loss for its flow resistance">
  <!-- Iubenda -->
...
<!-- End Google Tag Manager (noscript) -->
  ...
  <section class="case-hero">
    <div class="container">
      ...
      <h1>Visualization of Oil Lubrication in the Transfer Case and the Transmission using Particleworks</h1>
      <div class="case-meta">
        <strong><i class="bi bi-people me-1"></i> Toshiyuki Morimi, Prometech Software</strong>
        <span class="mx-2">|</span>
        <span><i class="bi bi-building me-1"></i> Univance Corporation</span>
      </div>
    </div>
  </section>
      ...
      <div class="row g-5">
        <div class="col-lg-8">
          <div class="case-image">
            <img src="images/case-studies/Univance_01_0.png" alt="Visualization of Oil Lubrication in the Transfer Case and the Transmission using Particleworks">
          </div>
          <h3 class="fw-bold mb-3">Abstract</h3>
          <p class="abstract-text">Univance Corporation uses Particleworks for fluid analysis including prediction during concept design, design validation before prototype testing, and quality improvement analysis.</p>
        </div>
        <div class="col-lg-4">
          <div class="sidebar-card mb-4">
            ...
            <div class="d-flex align-items-center mb-3">
              ...
              <div>
                ...
                <span class="fw-medium">Univance Corporation</span>
              </div>
            </div>
            <div class="d-flex align-items-center mb-3">
              ...
              <div class="d-flex align-items-center mb-3">
                ...
                <div>
                  ...
                  <span class="fw-medium">Newsletter EnginSoft Year 14 n&deg;2</span>
                </div>
              </div>
            <div class="d-flex align-items-center mb-3">
          ...
          <div class="sidebar-card">
            ...
            <div class="d-grid gap-2">
              <a href="images/case-studies/univance.pdf" class="btn btn-pw me-3 mb-2" target="_blank">
