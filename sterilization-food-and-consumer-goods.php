...
<head>
  ...
  <title>Case Studies: sterilization, food and consumer goods - Particleworks Europe</title>
  <meta name="description" content="Simulation of moving particles: discover the case studies of sterilization, food and consumer goods. Visit our website and check out insights, application and much more!">
  ...
  <style>
    :root {
      ...
      --pw-gray: #6c757d;
      --pw-light: #f8f9fa;
      --hero-accent: linear-gradient(135deg, #004d40 0%, #00695c 50%, #00897b 100%);
    }
    * { font-family: 'Inter', sans-serif; }
    ...
    .app-hero { position: relative; padding: 10rem 0 5rem; background: var(--hero-accent); overflow: hidden; min-height: 480px; }
    ...
    .app-hero::after { content: ''; position: absolute; inset: 0; background: linear-gradient(180deg, rgba(0,77,64,0.55) 0%, rgba(0,77,64,0.85) 100%); }
    .app-hero .container { position: relative; z-index: 2; }
    .app-hero .badge-industry { display: inline-flex; align-items: center; gap: 0.4rem; background: rgba(0,137,123,0.35); color: #fff; border: 1px solid rgba(0,137,123,0.6); padding: 0.3rem 0.9rem; border-radius: 50px; font-size: 0.78rem; font-weight: 700; letter-spacing: 0.5px; text-transform: uppercase; margin-bottom: 1.2rem; }
    ...
    .cap-card { background: #fff; border: 1px solid rgba(0,0,0,0.07); border-radius: 12px; padding: 1.25rem 1.5rem; transition: all 0.25s; height: 100%; }
    ...
    .case-card { display: block; background: #fff; border: 1px solid rgba(0,0,0,0.06); border-radius: 12px; padding: 1.5rem; text-decoration: none; transition: all 0.25s; height: 100%; }
...
<!-- === SEO head (auto-generated, matches backup website_now) === -->
  <link rel="canonical" href="https://particleworks-europe.com/sterilization-food-and-consumer-goods.html">
  ...
  <meta property="og:title" content="Case Studies: sterilization, food and consumer goods - Particleworks Europe">
  <meta property="og:description" content="Simulation of moving particles: discover the case studies of sterilization, food and consumer goods. Visit our website and check out insights, application and much more!">
  <meta property="og:url" content="https://particleworks-europe.com/sterilization-food-and-consumer-goods.html">
  <meta property="og:type" content="website">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Case Studies: sterilization, food and consumer goods - Particleworks Europe">
  <meta name="twitter:description" content="Simulation of moving particles: discover the case studies of sterilization, food and consumer goods. Visit our website and check out insights, application and much more!">
  <!-- Iubenda -->
...
<!-- End Google Tag Manager (noscript) -->
        ...
        <ul class="navbar-nav align-items-lg-center gap-1">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
              ...
              <li><a class="dropdown-item active" href="sterilization-food-and-consumer-goods.html"><i class="bi bi-droplet-half"></i><span><div class="dd-t">Sterilization &amp; Consumer Goods</div><div class="dd-s">Food and cleaning</div></span></a></li>
  ...
  <section class="app-body">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-10">
          ...
          <p>Managing sterilization processes for food and consumer goods requires precise control of thermal or chemical inactivation. Air removal, deep penetration of sterilizing agents while maintaining product integrity.</p>

          <p>Particleworks enables engineers to simulate the complex fluid dynamics of cleaning jets in dishwashers, the filling of bottles and pouches at production speed, and the sterilization coverage of complex geometries. The meshfree approach naturally handles the splashing, thin films, and multiphase interactions that are central to these consumer and food industry applications.</p>

          <figure class="app-figure"><img src="images/case-studies/sterilization-and-cleaning.webp" alt="Sterilization, cleaning and filling processes for food and consumer goods" loading="lazy"><figcaption>Sterilization, cleaning and filling processes for food and consumer goods</figcaption></figure>
          ...
          <div class="row g-3 mb-4">
            <div class="col-md-4 col-sm-6">
              <div class="cap-card">
                ...
                <h6>Cleaning jets directionality (dishwashers)</h6>
              </div>
            </div>
            <div class="col-md-4 col-sm-6">
              <div class="cap-card">
                <div class="cap-icon"><i class="bi bi-droplet-half"></i></div>
                <h6>Non-Newtonian residue scraping</h6>
              </div>
            </div>
            <div class="col-md-4 col-sm-6">
              <div class="cap-card">
                <div class="cap-icon"><i class="bi bi-eye"></i></div>
                <h6>Sterilized surface visualization</h6>
              </div>
            </div>
            <div class="col-md-4 col-sm-6">
              <div class="cap-card">
                <div class="cap-icon"><i class="bi bi-speedometer2"></i></div>
                <h6>Bottle/pouch filling speed</h6>
              </div>
            </div>
            <div class="col-md-4 col-sm-6">
              <div class="cap-card">
                <div class="cap-icon"><i class="bi bi-box"></i></div>
                <h6>Packaging deformation</h6>
              </div>
            </div>
            <div class="col-md-4 col-sm-6">
              <div class="cap-card">
                <div class="cap-icon"><i class="bi bi-layers"></i></div>
                <h6>Multi-phase food mixtures</h6>
              </div>
            </div>
          </div>
          ...
          <div class="row g-4 mb-4">
            <div class="col-lg-6">
              <div class="video-wrap">
                <iframe src="https://www.youtube.com/embed/H8QQ0OXJ4LE?autoplay=1&mute=1&loop=1&playlist=H8QQ0OXJ4LE&controls=0&showinfo=0" title="Sterilization simulation" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="video-wrap">
                <iframe src="https://www.youtube.com/embed/UtuuuXnarDQ?autoplay=1&mute=1&loop=1&playlist=UtuuuXnarDQ&controls=0&showinfo=0" title="Cleaning jet simulation" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="video-wrap">
                <iframe src="https://www.youtube.com/embed/-gbD72-ckPA?autoplay=1&mute=1&loop=1&playlist=-gbD72-ckPA&controls=0&showinfo=0" title="Food packaging simulation" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
            </div>
          </div>
          ...
          <div class="row g-3">
            <div class="col-md-3">
              <a href="cases/spm.html" class="case-card">
                <h5>SPM</h5>
                <span class="card-arrow"><i class="bi bi-arrow-right"></i></span>
              </a>
            </div>
            <div class="col-md-3">
              <a href="cases/lion.html" class="case-card">
                <h5>Lion</h5>
                <span class="card-arrow"><i class="bi bi-arrow-right"></i></span>
              </a>
            </div>
            <div class="col-md-3">
              <a href="cases/lixil.html" class="case-card">
                <h5>Lixil</h5>
                <span class="card-arrow"><i class="bi bi-arrow-right"></i></span>
              </a>
            </div>
            <div class="col-md-3">
              <a href="cases/unitn.html" class="case-card">
                <h5>UniTN</h5>
                <span class="card-arrow"><i class="bi bi-arrow-right"></i></span>
              </a>
            </div>
    ...
    <div class="container">
      ...
      <div class="row g-3">
            ...
            <div class="col-lg-4 col-md-6">
              <a href="gearboxes-and-bearings.html" class="app-tile">
            ...
            <div class="col-lg-4 col-md-6">
              <a href="sterilization-food-and-consumer-goods.html" class="app-tile current">
            ...
            <div class="col-lg-4 col-md-6">
              <a href="civil-engineering-and-fire-prevention.html" class="app-tile">
  ...
  <section class="cta-section">
    <div class="container text-center">
      ...
      <p style="color:var(--pw-gray); max-width:520px; margin:0 auto 1.5rem; font-size:1.05rem;">Request a personalized demo to explore sterilization and food process simulation.</p>
    ...
    <div class="container">
      <div class="row g-4">
        ...
        <div class="col-lg-2 col-md-4">
          ...
          <ul class="list-unstyled small"><li class="mb-2"><a href="index.html">Particleworks</a></li><li class="mb-2"><a href="index.html">Granuleworks</a></li></ul>
        </div>
        <div class="col-lg-2 col-md-4">
          <h6 class="fw-semibold text-white mb-3" style="font-size:0.85rem;">Services</h6>
          <ul class="list-unstyled small"><li class="mb-2"><a href="index.html">Consulting</a></li><li class="mb-2"><a href="index.html">Training</a></li><li class="mb-2"><a href="index.html">Support</a></li></ul>
        </div>
        <div class="col-lg-2 col-md-4">
          <h6 class="fw-semibold text-white mb-3" style="font-size:0.85rem;">Resources</h6>
          <ul class="list-unstyled small"><li class="mb-2"><a href="index.html#case-studies">Case Studies</a></li></ul>
        </div>
        <div class="col-lg-2">
