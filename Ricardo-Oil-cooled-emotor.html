...
<head>
  ...
  <meta name="description" content="Case study: Thermal Simulation of an Oil-Cooled E-Motor">
...
<!-- === SEO head (auto-generated, matches backup website_now) === -->
  <link rel="canonical" href="https://particleworks-europe.com/Ricardo-Oil-cooled-emotor.html">
  ...
  <meta property="og:description" content="Case study: Thermal Simulation of an Oil-Cooled E-Motor">
  <meta property="og:url" content="https://particleworks-europe.com/Ricardo-Oil-cooled-emotor.html">
  <meta property="og:type" content="website">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Moving Particle Simulation: the case studies of Particleworks Europe">
  <meta name="twitter:description" content="Case study: Thermal Simulation of an Oil-Cooled E-Motor">
  <!-- Iubenda -->
...
<!-- End Google Tag Manager (noscript) -->
  ...
  <section class="case-hero">
    <div class="container">
      ...
      <h1>Thermal Simulation of an Oil-Cooled E-Motor</h1>
      <div class="case-meta">
        <strong><i class="bi bi-people me-1"></i> Martin Brada, Ricardo</strong>
        <span class="mx-2">|</span>
        <span><i class="bi bi-building me-1"></i> Ricardo</span>
      </div>
    </div>
  </section>
      ...
      <div class="row g-5">
        <div class="col-lg-8">
          <div class="case-image">
            <img src="images/case-studies/Ricardo_01_3.png" alt="Thermal Simulation of an Oil-Cooled E-Motor">
          </div>
          <h3 class="fw-bold mb-3">Abstract</h3>
          <p class="abstract-text">Temperature prediction of windings validated against experimental data using particle-based CFD. Advanced technique of simulating air and oil flow separately with different particle sizes. Correlation with experimental data deemed satisfactory.</p>
        </div>
        <div class="col-lg-4">
          <div class="sidebar-card mb-4">
            ...
            <div class="d-flex align-items-center mb-3">
              ...
              <div>
                ...
                <span class="fw-medium">Ricardo</span>
              </div>
            </div>
            <div class="d-flex align-items-center mb-3">
          ...
          <div class="sidebar-card">
            ...
            <div class="d-grid gap-2">
              ...
              <a href="https://particleworks-europe.forms-eu.com/embed.php?id=15780" class="btn btn-pw-green me-3 mb-2" target="_blank">
