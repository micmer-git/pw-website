...
<head>
  ...
  <meta name="description" content="Case study: Gear oil jet lubrication efficiency">
...
<!-- === SEO head (auto-generated, matches backup website_now) === -->
  <link rel="canonical" href="https://particleworks-europe.com/GIMATransmissionTechnology-Gearoiljetlubrication.html">
  ...
  <meta property="og:description" content="Case study: Gear oil jet lubrication efficiency">
  <meta property="og:url" content="https://particleworks-europe.com/GIMATransmissionTechnology-Gearoiljetlubrication.html">
  <meta property="og:type" content="website">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Moving Particle Simulation: the case studies of Particleworks Europe">
  <meta name="twitter:description" content="Case study: Gear oil jet lubrication efficiency">
  <!-- Iubenda -->
...
<!-- End Google Tag Manager (noscript) -->
  ...
  <section class="case-hero">
    <div class="container">
      ...
      <h1>Gear oil jet lubrication efficiency</h1>
      <div class="case-meta">
        <strong><i class="bi bi-people me-1"></i> Oscar Cuevas, GIMA Transmission Technology</strong>
        <span class="mx-2">|</span>
        <span><i class="bi bi-building me-1"></i> GIMA Transmission Technology</span>
      </div>
    </div>
  </section>
      ...
      <div class="row g-5">
        <div class="col-lg-8">
          <div class="case-image">
            <img src="images/case-studies/GIMATransmissionTechnology_02_1.png" alt="Gear oil jet lubrication efficiency">
          </div>
          <h3 class="fw-bold mb-3">Abstract</h3>
          <p class="abstract-text">New developments look to improve efficiency to reduce CO2 emissions. By reducing gear churning losses through oil jet lubrication, important savings can be made. We analyzed one gear train in different conditions with Particleworks to establish rules for lubrication oil flow efficiency.</p>
        </div>
        <div class="col-lg-4">
          <div class="sidebar-card mb-4">
            ...
            <div class="d-flex align-items-center mb-3">
              ...
              <div>
                ...
                <span class="fw-medium">GIMA Transmission Technology</span>
              </div>
            </div>
            <div class="d-flex align-items-center mb-3">
          ...
          <div class="sidebar-card">
            ...
            <div class="d-grid gap-2">
              <a href="images/case-studies/CAE2019_Gima_Transmission.pdf" class="btn btn-pw me-3 mb-2" target="_blank">
