...
<head>
  ...
  <title>Meshless CFD: the training for Particleworks software – Particleworks</title>
  <meta name="description" content="Meshless CFD: discover the variety of training to help you realize the potential of Particleworks software. See our website and contact us!">
...
<!-- === SEO head (auto-generated, matches backup website_now) === -->
  <link rel="canonical" href="https://particleworks-europe.com/training.html">
  ...
  <meta property="og:title" content="Meshless CFD: the training for Particleworks software – Particleworks">
  <meta property="og:description" content="Meshless CFD: discover the variety of training to help you realize the potential of Particleworks software. See our website and contact us!">
  <meta property="og:url" content="https://particleworks-europe.com/training.html">
  <meta property="og:type" content="website">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Meshless CFD: the training for Particleworks software – Particleworks">
  <meta name="twitter:description" content="Meshless CFD: discover the variety of training to help you realize the potential of Particleworks software. See our website and contact us!">
...
<body>
        ...
        <ul class="navbar-nav align-items-lg-center gap-1">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a class="dropdown-item active" href="training.html"><i class="bi bi-mortarboard"></i><span><div class="dd-t">Training</div><div class="dd-s">Courses &amp; workshops</div></span></a></li>
  ...
  <main>
    <!-- company banner title -->
      <section class="main_section background-blue">
          <div class="container">
              <div class="row">
                  <div class="col-12">
                      <h1 class="display-6 text-end text-uppercase text-white pt-2">Training</h1>
                  </div></div></div>
              </section>
   ...
   <!-- training  -->      
      ...
      <div class="col-md-7 pb-4 pe-4">
        <h2 class="featurette-heading">We offer <span class="text-muted">a variety of training </span></h2>
        <p class="lead pt-4">Particleworks Europe offers a variety of training to help you realize the potential of Particleworks software, in in-house and on-site modalities.</p>
         <p class="lead">Our training programs are carefully designed to ensure that you and your colleagues get the most out of Particleworks in the shortest possible time. Our courses include introductory and advanced topics, and we can develop customized courses to meet your unique needs.</p>
          <div class="p-3 background_gray my-auto d-block">
          <p>For information about training programs, or to schedule an on-site training course at your facility, please</p> <a href="contact.html" class="btn btn-primary text-uppercase"> Contact us</a>
              </div>
      </div>     
    <div class="col-md-5">  
         <img src="images/PW_training.png" class="img-fluid rounded-circle box-icon-blue bg-white float-end my-3">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="images/PW_consulting03.png" class="d-block w-100" alt="A variety of training">
    </div>
    <div class="carousel-item">
       <img src="images/PW_consulting02.png" class="d-block w-100" alt="Our training programs are carefully designed">
    </div>
    <div class="carousel-item">
      <img src="images/PW_consulting01.png" class="d-block w-100" alt="Introductory and advanced topics">
    </div>
  </div> 
</div>
