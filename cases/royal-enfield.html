...
<head>
  ...
  <meta name="description" content="Case study: Optimization of the Piston cooling oil jet using Particleworks with modeFRONTIER">
...
<!-- === SEO head (auto-generated, matches backup website_now) === -->
  <link rel="canonical" href="https://particleworks-europe.com/RoyalEnfield-Pistoncooling.html">
  ...
  <meta property="og:description" content="Case study: Optimization of the Piston cooling oil jet using Particleworks with modeFRONTIER">
  <meta property="og:url" content="https://particleworks-europe.com/RoyalEnfield-Pistoncooling.html">
  <meta property="og:type" content="website">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Moving Particle Simulation: the case studies of Particleworks Europe">
  <meta name="twitter:description" content="Case study: Optimization of the Piston cooling oil jet using Particleworks with modeFRONTIER">
  <!-- Iubenda -->
...
<!-- End Google Tag Manager (noscript) -->
  ...
  <section class="case-hero">
    <div class="container">
      ...
      <h1>Optimization of the Piston cooling oil jet using Particleworks with modeFRONTIER</h1>
      <div class="case-meta">
        <strong><i class="bi bi-people me-1"></i> David Percival (EnginSoft), Rod Giles (Royal Enfield)</strong>
        <span class="mx-2">|</span>
        <span><i class="bi bi-building me-1"></i> Royal Enfield</span>
      </div>
    </div>
  </section>
      ...
      <div class="row g-5">
        <div class="col-lg-8">
          <div class="case-image">
            <img src="../images/case-studies/RoyalEnfield_01.png" alt="Optimization of the Piston cooling oil jet using Particleworks with modeFRONTIER">
          </div>
          <h3 class="fw-bold mb-3">Abstract</h3>
          <p class="abstract-text">By employing MPS with accelerated hardware, computational time reduced to only 15 minutes, bringing design optimization into feasibility. Demonstrates modification of cooling jet design to optimize cooling effect on the piston.</p>
        </div>
        <div class="col-lg-4">
          <div class="sidebar-card mb-4">
            ...
            <div class="d-flex align-items-center mb-3">
              ...
              <div>
                ...
                <span class="fw-medium">Royal Enfield</span>
              </div>
            </div>
            <div class="d-flex align-items-center mb-3">
          ...
          <div class="sidebar-card">
            ...
            <div class="d-grid gap-2">
              <a href="../images/case-studies/CAE2019_ESUK-RE-Piston-Cooling.pdf" class="btn btn-pw me-3 mb-2" target="_blank">
