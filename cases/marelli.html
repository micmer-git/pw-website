...
<head>
  ...
  <meta name="description" content="Case study: Oil lubricated bearing support analysis on electric generators with mesh-less CFD methods">
...
<!-- === SEO head (auto-generated, matches backup website_now) === -->
  <link rel="canonical" href="https://particleworks-europe.com/MarelliMotori-Oillubricatedbearings.html">
  ...
  <meta property="og:description" content="Case study: Oil lubricated bearing support analysis on electric generators with mesh-less CFD methods">
  <meta property="og:url" content="https://particleworks-europe.com/MarelliMotori-Oillubricatedbearings.html">
  <meta property="og:type" content="website">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Moving Particle Simulation: the case studies of Particleworks Europe">
  <meta name="twitter:description" content="Case study: Oil lubricated bearing support analysis on electric generators with mesh-less CFD methods">
  <!-- Iubenda -->
...
<!-- End Google Tag Manager (noscript) -->
  ...
  <section class="case-hero">
    <div class="container">
      ...
      <h1>Oil lubricated bearing support analysis on electric generators with mesh-less CFD methods</h1>
      <div class="case-meta">
        <strong><i class="bi bi-people me-1"></i> Nicola Pretto (MarelliMotori), D. Pesenti &amp; M. Galbiati (EnginSoft)</strong>
        <span class="mx-2">|</span>
        <span><i class="bi bi-building me-1"></i> MarelliMotori</span>
      </div>
    </div>
  </section>
      ...
      <div class="row g-5">
        <div class="col-lg-8">
          <div class="case-image">
            <img src="../images/case-studies/MarelliMotori_01.png" alt="Oil lubricated bearing support analysis on electric generators with mesh-less CFD methods">
          </div>
          <h3 class="fw-bold mb-3">Abstract</h3>
          <p class="abstract-text">Marelli Motori, a designer and manufacturer of electrical motors and generators since 1891, tested Particleworks for oil lubricated bearing support analysis, enabling simulation of oil flow path inside machines and modeling large-scale equipment behaviour.</p>
        </div>
        <div class="col-lg-4">
          <div class="sidebar-card mb-4">
            ...
            <div class="d-flex align-items-center mb-3">
              ...
              <div>
                ...
                <span class="fw-medium">MarelliMotori</span>
              </div>
            </div>
            <div class="d-flex align-items-center mb-3">
              ...
              <div class="d-flex align-items-center mb-3">
                ...
                <div>
                  ...
                  <span class="fw-medium">International CAE Conference 2019</span>
                </div>
              </div>
            <div class="d-flex align-items-center mb-3">
          ...
          <div class="sidebar-card">
            ...
            <div class="d-grid gap-2">
              <a href="../images/case-studies/CAE2019_MarelliMotori_Bearings.pdf" class="btn btn-pw me-3 mb-2" target="_blank">
