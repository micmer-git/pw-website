...
<head>
  ...
  <meta name="description" content="Case study: Electric motor cooling simulation: direct vs indirect">
...
<!-- === SEO head (auto-generated, matches backup website_now) === -->
  <link rel="canonical" href="https://particleworks-europe.com/TotalEnergies_Electric-motor-cooling-simulation.html">
  ...
  <meta property="og:description" content="Case study: Electric motor cooling simulation: direct vs indirect">
  <meta property="og:url" content="https://particleworks-europe.com/TotalEnergies_Electric-motor-cooling-simulation.html">
  <meta property="og:type" content="website">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Moving Particle Simulation: the case studies of Particleworks Europe">
  <meta name="twitter:description" content="Case study: Electric motor cooling simulation: direct vs indirect">
  <!-- Iubenda -->
...
<!-- End Google Tag Manager (noscript) -->
  ...
  <section class="case-hero">
    <div class="container">
      ...
      <h1>Electric motor cooling simulation: direct vs indirect</h1>
      <div class="case-meta">
        <strong><i class="bi bi-people me-1"></i> Jonathan Raisin, TotalEnergies</strong>
        <span class="mx-2">|</span>
        <span><i class="bi bi-building me-1"></i> TotalEnergies</span>
      </div>
    </div>
  </section>
      ...
      <div class="row g-5">
        <div class="col-lg-8">
          <div class="case-image">
            <img src="../images/case-studies/TotalEnergies_JonathanRaisin.png" alt="Electric motor cooling simulation: direct vs indirect">
          </div>
          <h3 class="fw-bold mb-3">Abstract</h3>
          <p class="abstract-text">TotalEnergies studied through simulation the efficiency of direct oil cooling systems for electric and hybrid vehicles, showing it is and will be the future for e-mobility cooling.</p>
        </div>
        <div class="col-lg-4">
          <div class="sidebar-card mb-4">
            ...
            <div class="d-flex align-items-center mb-3">
              ...
              <div>
                ...
                <span class="fw-medium">TotalEnergies</span>
              </div>
            </div>
            <div class="d-flex align-items-center mb-3">
              ...
              <div class="d-flex align-items-center mb-3">
                ...
                <div>
                  ...
                  <span class="fw-medium">International CAE Conference 2021</span>
                </div>
              </div>
            <div class="d-flex align-items-center mb-3">
          ...
          <div class="sidebar-card">
            ...
            <div class="d-grid gap-2">
              ...
              <a href="https://particleworks-europe.forms-eu.com/embed.php?id=13003" class="btn btn-pw-green me-3 mb-2" target="_blank">
