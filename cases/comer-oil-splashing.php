...
<head>
  ...
  <meta name="description" content="Case study: Oil splashing, Lubrication and Churning losses prediction by moving Particle Simulation">
...
<!-- === SEO head (auto-generated, matches backup website_now) === -->
  <link rel="canonical" href="https://particleworks-europe.com/ComerIndustries-Oilsplashing.html">
  ...
  <meta property="og:description" content="Case study: Oil splashing, Lubrication and Churning losses prediction by moving Particle Simulation">
  <meta property="og:url" content="https://particleworks-europe.com/ComerIndustries-Oilsplashing.html">
  <meta property="og:type" content="website">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Moving Particle Simulation: the case studies of Particleworks Europe">
  <meta name="twitter:description" content="Case study: Oil splashing, Lubrication and Churning losses prediction by moving Particle Simulation">
  <!-- Iubenda -->
...
<!-- End Google Tag Manager (noscript) -->
  ...
  <section class="case-hero">
    <div class="container">
      ...
      <h1>Oil splashing, Lubrication and Churning losses prediction by Moving Particle Simulation</h1>
      <div class="case-meta">
        <strong><i class="bi bi-people me-1"></i> Salvatore Ruffino (Comer Industries), Ragnar Skoglund &amp; Massimo Galbiati (EnginSoft)</strong>
      ...
      <div class="row g-5">
        <div class="col-lg-8">
          <div class="case-image">
            <img src="../images/case-studies/comer_industries_02.png" alt="Oil splashing, Lubrication and Churning losses prediction by Moving Particle Simulation">
          </div>
          <h3 class="fw-bold mb-3">Abstract</h3>
          <p class="abstract-text">Lubrication, churning losses and heat dissipation are fundamental aspects in the design of gear boxes and transmission systems. These three aspects affect the functionality, life and efficiency of the device. This paper shows how particle based methods like the Moving Particle Simulation (MPS) can simulate lubrication and oil splashing by completely eliminating mesh generation from the CFD process and by drastically reducing the simulation time.</p>
        </div>
        <div class="col-lg-4">
          ...
          <div class="sidebar-card">
            ...
            <div class="d-grid gap-2">
              <a href="../images/case-studies/COMERINDUSTRIES_OilSplashing_NL17-3.pdf" class="btn btn-pw me-3 mb-2" target="_blank">
