...
<head>
  ...
  <meta name="description" content="Case study: Simulating fire extinguishing equipment for historical buildings with Particleworks and Granuleworks">
...
<!-- === SEO head (auto-generated, matches backup website_now) === -->
  <link rel="canonical" href="https://particleworks-europe.com/simulating-fire-for-historical-buildings.html">
  ...
  <meta property="og:description" content="Case study: Simulating fire extinguishing equipment for historical buildings with Particleworks and Granuleworks">
  <meta property="og:url" content="https://particleworks-europe.com/simulating-fire-for-historical-buildings.html">
  <meta property="og:type" content="website">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Moving Particle Simulation: the case studies of Particleworks Europe">
  <meta name="twitter:description" content="Case study: Simulating fire extinguishing equipment for historical buildings with Particleworks and Granuleworks">
  <!-- Iubenda -->
...
<!-- End Google Tag Manager (noscript) -->
  ...
  <section class="case-hero">
    <div class="container">
      <div class="industry-badge"><i class="bi-building"></i> Civil & Energy</div>
      <h1>Simulating fire extinguishing equipment for historical buildings with Particleworks and Granuleworks</h1>
      <div class="case-meta">
        <strong><i class="bi bi-people me-1"></i> Sunao Tokura, Shun Fujimoto, Akiko Kondoh (Prometech Software)</strong>
        <span class="mx-2">|</span>
        <span><i class="bi bi-building me-1"></i> Prometech Software</span>
      </div>
    </div>
  </section>
      ...
      <div class="row g-5">
        <div class="col-lg-8">
          <div class="case-image">
            <img src="../images/case-studies/Simulating-fire.png" alt="Simulating fire extinguishing equipment for historical buildings with Particleworks and Granuleworks">
          </div>
          <h3 class="fw-bold mb-3">Abstract</h3>
          <p class="abstract-text">Simulation of three types of firefighting equipment for cultural heritage buildings: water discharge gun, drencher, and firefighting drone. Numerical simulation beneficial for first evaluation of firefighting equipment's effectiveness.</p>
        </div>
        <div class="col-lg-4">
          <div class="sidebar-card mb-4">
            ...
            <div class="d-flex align-items-center mb-3">
              ...
              <div>
                ...
                <span class="fw-medium">Prometech Software</span>
              </div>
            </div>
            <div class="d-flex align-items-center mb-3">
              <div class="info-icon"><i class="bi-building"></i></div>
              <div>
                <small class="text-muted d-block">Industry</small>
                <span class="fw-medium">Civil & Energy</span>
              </div>
            </div>
              <div class="d-flex align-items-center mb-3">
                ...
                <div>
                  ...
                  <span class="fw-medium">EnginSoft Newsletter Summer 2021</span>
                </div>
              </div>
            <div class="d-flex align-items-center mb-3">
          ...
          <div class="sidebar-card">
            ...
            <div class="d-grid gap-2">
              ...
              <a href="https://particleworks-europe.forms-eu.com/embed.php?id=15039" class="btn btn-pw-green me-3 mb-2" target="_blank">
