...
<head>
  ...
  <meta name="description" content="Case study: Oil flow rate optimization of an axle with an integrated input planetary stage for an uphill and downhill path">
...
<!-- === SEO head (auto-generated, matches backup website_now) === -->
  <link rel="canonical" href="https://particleworks-europe.com/comer-oil-flow-rate.html">
  ...
  <meta property="og:description" content="Case study: Oil flow rate optimization of an axle with an integrated input planetary stage for an uphill and downhill path">
  <meta property="og:url" content="https://particleworks-europe.com/comer-oil-flow-rate.html">
  <meta property="og:type" content="website">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Moving Particle Simulation: the case studies of Particleworks Europe">
  <meta name="twitter:description" content="Case study: Oil flow rate optimization of an axle with an integrated input planetary stage for an uphill and downhill path">
  <!-- Iubenda -->
...
<!-- End Google Tag Manager (noscript) -->
  ...
  <section class="case-hero">
    <div class="container">
      ...
      <h1>Oil flow rate optimization of an axle with an integrated input planetary stage for an uphill and downhill path</h1>
      <div class="case-meta">
        <strong><i class="bi bi-people me-1"></i> Elisabetta Fava, Comer Industries SpA</strong>
        <span class="mx-2">|</span>
        <span><i class="bi bi-building me-1"></i> Comer Industries</span>
      </div>
    </div>
  </section>
      ...
      <div class="row g-5">
        <div class="col-lg-8">
          <div class="case-image">
            <img src="../images/case-studies/comer_industries_img03.png" alt="Oil flow rate optimization of an axle with an integrated input planetary stage for an uphill and downhill path">
          </div>
          <h3 class="fw-bold mb-3">Abstract</h3>
          <p class="abstract-text">An axle with an integrated input planetary stage has been simulated with ParticleWorks to predict the oil flow path in the planetary stage when the machine faces changes of slope. Three simulations were run to optimize housing oil passages geometry and oil level for proper lubrication during sloped configurations.</p>
        </div>
        <div class="col-lg-4">
          <div class="sidebar-card mb-4">
            ...
            <div class="d-flex align-items-center mb-3">
              ...
              <div>
                ...
                <span class="fw-medium">Comer Industries</span>
              </div>
            </div>
            <div class="d-flex align-items-center mb-3">
          ...
          <div class="sidebar-card">
            ...
            <div class="d-grid gap-2">
              ...
              <a href="https://particleworks-europe.forms-eu.com/embed.php?id=17530" class="btn btn-pw-green me-3 mb-2" target="_blank">
