...
<head>
  ...
  <meta name="description" content="Case study: Thermal Optimisation of e-Drives Using Moving Particle Semi-implicit (MPS) Method">
...
<!-- === SEO head (auto-generated, matches backup website_now) === -->
  <link rel="canonical" href="https://particleworks-europe.com/DriveSystemDesign-edrivecooling.html">
  ...
  <meta property="og:description" content="Case study: Thermal Optimisation of e-Drives Using Moving Particle Semi-implicit (MPS) Method">
  <meta property="og:url" content="https://particleworks-europe.com/DriveSystemDesign-edrivecooling.html">
  <meta property="og:type" content="website">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Moving Particle Simulation: the case studies of Particleworks Europe">
  <meta name="twitter:description" content="Case study: Thermal Optimisation of e-Drives Using Moving Particle Semi-implicit (MPS) Method">
  <!-- Iubenda -->
...
<!-- End Google Tag Manager (noscript) -->
  ...
  <section class="case-hero">
    <div class="container">
      <div class="industry-badge"><i class="bi-lightning-charge"></i> E-Motors & Electric Drives</div>
      <h1>Thermal Optimisation of e-Drives Using Moving Particle Semi-implicit (MPS) Method</h1>
      <div class="case-meta">
        <strong><i class="bi bi-people me-1"></i> Luca Martinelli &amp; Matt Hole (Drive System Design Ltd), Davide Pesenti &amp; Massimo Galbiati (EnginSoft)</strong>
        <span class="mx-2">|</span>
        <span><i class="bi bi-building me-1"></i> Drive System Design Ltd</span>
      </div>
    </div>
  </section>
      ...
      <div class="row g-5">
        <div class="col-lg-8">
          <div class="case-image">
            <img src="../images/case-studies/DriveSystemDesign_01.png" alt="Thermal Optimisation of e-Drives Using Moving Particle Semi-implicit (MPS) Method">
          </div>
          <h3 class="fw-bold mb-3">Abstract</h3>
          <p class="abstract-text">A novel technique to model the temperature of windings in oil cooled e-machines. It uses a combination of particle based fluid modelling and steady state finite element thermal modelling. The fluid model generates a heat transfer coefficient (HTC) map for the complex multi-phase flow, applied to an FE model. Models can be generated and solved in under a week.</p>
        </div>
        <div class="col-lg-4">
          <div class="sidebar-card mb-4">
            ...
            <div class="d-flex align-items-center mb-3">
              ...
              <div>
                ...
                <span class="fw-medium">Drive System Design Ltd</span>
              </div>
            </div>
            <div class="d-flex align-items-center mb-3">
              <div class="info-icon"><i class="bi-lightning-charge"></i></div>
              <div>
                <small class="text-muted d-block">Industry</small>
                <span class="fw-medium">E-Motors & Electric Drives</span>
              </div>
            </div>
              <div class="d-flex align-items-center mb-3">
                ...
                <div>
                  ...
                  <span class="fw-medium">Newsletter EnginSoft Year 15 n&deg;3</span>
                </div>
              </div>
            <div class="d-flex align-items-center mb-3">
          ...
          <div class="sidebar-card">
            ...
            <div class="d-grid gap-2">
              <a href="../images/case-studies/DriveSystemDesign-NL.pdf" class="btn btn-pw me-3 mb-2" target="_blank">
