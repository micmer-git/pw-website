...
<head>
  ...
  <meta name="description" content="Case study: Comparison between CFD and MPS Methods for Numerical Simulation of Pelton turbine">
...
<!-- === SEO head (auto-generated, matches backup website_now) === -->
  <link rel="canonical" href="https://particleworks-europe.com/ZECO-Peltonturbine.html">
  ...
  <meta property="og:description" content="Case study: Comparison between CFD and MPS Methods for Numerical Simulation of Pelton turbine">
  <meta property="og:url" content="https://particleworks-europe.com/ZECO-Peltonturbine.html">
  <meta property="og:type" content="website">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Moving Particle Simulation: the case studies of Particleworks Europe">
  <meta name="twitter:description" content="Case study: Comparison between CFD and MPS Methods for Numerical Simulation of Pelton turbine">
  <!-- Iubenda -->
...
<!-- End Google Tag Manager (noscript) -->
  ...
  <section class="case-hero">
    <div class="container">
      ...
      <h1>Comparison between CFD and MPS Methods for Numerical Simulation of Pelton turbine</h1>
      <div class="case-meta">
        <strong><i class="bi bi-people me-1"></i> Riccardo Bergamin (ZECO), Michele Merelli (EnginSoft)</strong>
        <span class="mx-2">|</span>
        <span><i class="bi bi-building me-1"></i> ZECO</span>
      </div>
    </div>
  </section>
      ...
      <div class="row g-5">
        <div class="col-lg-8">
          <div class="case-image">
            <img src="../images/case-studies/Zeco_01.png" alt="Comparison between CFD and MPS Methods for Numerical Simulation of Pelton turbine">
          </div>
          <h3 class="fw-bold mb-3">Abstract</h3>
          <p class="abstract-text">CFD modelling of Pelton turbines is challenging due to transient multi-phase flow. Using MPS with Particleworks, these barriers can be overcome with a technological breakthrough for new optimization opportunities.</p>
        </div>
        <div class="col-lg-4">
          <div class="sidebar-card mb-4">
            ...
            <div class="d-flex align-items-center mb-3">
              ...
              <div>
                ...
                <span class="fw-medium">ZECO</span>
              </div>
            </div>
            <div class="d-flex align-items-center mb-3">
          ...
          <div class="sidebar-card">
            ...
            <div class="d-grid gap-2">
              <a href="../images/case-studies/CAE2019_Zeco_Pelton.pdf" class="btn btn-pw me-3 mb-2" target="_blank">
