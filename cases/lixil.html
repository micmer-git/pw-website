...
<head>
  ...
  <meta name="description" content="Case study: Testing ParticleWorks coupled with Recurdyn to simulate water behavior in water technology products">
...
<!-- === SEO head (auto-generated, matches backup website_now) === -->
  <link rel="canonical" href="https://particleworks-europe.com/LIXIL-water-technology.html">
  ...
  <meta property="og:description" content="Case study: Testing ParticleWorks coupled with Recurdyn to simulate water behavior in water technology products">
  <meta property="og:url" content="https://particleworks-europe.com/LIXIL-water-technology.html">
  <meta property="og:type" content="website">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Moving Particle Simulation: the case studies of Particleworks Europe">
  <meta name="twitter:description" content="Case study: Testing ParticleWorks coupled with Recurdyn to simulate water behavior in water technology products">
  <!-- Iubenda -->
...
<!-- End Google Tag Manager (noscript) -->
  ...
  <section class="case-hero">
    <div class="container">
      <div class="industry-badge"><i class="bi-box-seam"></i> Consumer & Packaging</div>
      <h1>Testing ParticleWorks coupled with Recurdyn to simulate water behavior in water technology products</h1>
      <div class="case-meta">
        <strong><i class="bi bi-people me-1"></i> Chiaki Miyazawa (LIXIL Corporation), Akiko Kondoh (Prometech Software)</strong>
        <span class="mx-2">|</span>
        <span><i class="bi bi-building me-1"></i> LIXIL Corporation</span>
      </div>
    </div>
  </section>
  ...
  <section class="case-content">
        ...
        <div class="col-lg-4">
          <div class="sidebar-card mb-4">
            ...
            <div class="d-flex align-items-center mb-3">
              ...
              <div>
                ...
                <span class="fw-medium">LIXIL Corporation</span>
              </div>
            </div>
            <div class="d-flex align-items-center mb-3">
              <div class="info-icon"><i class="bi-box-seam"></i></div>
              <div>
                <small class="text-muted d-block">Industry</small>
                <span class="fw-medium">Consumer & Packaging</span>
              </div>
            </div>
              <div class="d-flex align-items-center mb-3">
                <div class="info-icon"><i class="bi bi-journal-text"></i></div>
                <div>
                  <small class="text-muted d-block">Publication</small>
                  <span class="fw-medium">Newsletter EnginSoft Year 17 n&deg;2</span>
                </div>
              </div>
            <div class="d-flex align-items-center mb-3">
          ...
          <div class="sidebar-card">
            ...
            <div class="d-grid gap-2">
              <a href="../images/case-studies/LixilCorporation-WaterTechnology.pdf" class="btn btn-pw me-3 mb-2" target="_blank">
    ...
    <section class="quote-section">
      <div class="container text-center">
        <blockquote>
          <i class="bi bi-quote" style="font-size:2.5rem;opacity:0.3;display:block;margin-bottom:1rem;"></i>
          &ldquo;The Particleworks features are a great advantage because they allowed the behavior of the shower and the internal impellers to be easily reproduced.&rdquo;
        </blockquote>
        <cite class="d-block mt-3">&mdash; Dr. Miyazawa, LIXIL</cite>
      </div>
    </section>
  <footer>
    <div class="container">
