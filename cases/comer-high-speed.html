...
<head>
  ...
  <meta name="description" content="Case study: Oil Path Prediction and Optimization for High Speed Transmissions with ParticleWorks">
...
<!-- === SEO head (auto-generated, matches backup website_now) === -->
  <link rel="canonical" href="https://particleworks-europe.com/ComerIndustries-HighSpeedTransmissions.html">
  ...
  <meta property="og:description" content="Case study: Oil Path Prediction and Optimization for High Speed Transmissions with ParticleWorks">
  <meta property="og:url" content="https://particleworks-europe.com/ComerIndustries-HighSpeedTransmissions.html">
  <meta property="og:type" content="website">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Moving Particle Simulation: the case studies of Particleworks Europe">
  <meta name="twitter:description" content="Case study: Oil Path Prediction and Optimization for High Speed Transmissions with ParticleWorks">
  <!-- Iubenda -->
...
<!-- End Google Tag Manager (noscript) -->
  ...
  <section class="case-hero">
    <div class="container">
      ...
      <h1>Oil Path Prediction and Optimization for High Speed Transmissions with ParticleWorks</h1>
      <div class="case-meta">
        <strong><i class="bi bi-people me-1"></i> Elisabetta Fava, Comer Industries</strong>
      ...
      <div class="row g-5">
        <div class="col-lg-8">
          <div class="case-image">
            <img src="../images/case-studies/ElisabettaFava_01.png" alt="Oil Path Prediction and Optimization for High Speed Transmissions with ParticleWorks">
          </div>
          <h3 class="fw-bold mb-3">Abstract</h3>
          <p class="abstract-text">The oil flow prediction has always been a challenge for the designer. Being able to predict the path followed by the oil inside a transmission before the functional tests is not easy, especially for transmissions working in wide ranges of speed and temperature, but it would give great advantages. In particular, it would allow to shape properly the housings geometry, to define the most suitable oil level and to estimate whether the temperature can reach dangerous levels, minimizing the development costs and time.</p>
        </div>
        <div class="col-lg-4">
          ...
          <div class="sidebar-card">
            ...
            <div class="d-grid gap-2">
              <a href="../images/case-studies/CAE2018_Comer-Industries_high_speed_transmission_bearings.pdf" class="btn btn-pw me-3 mb-2" target="_blank">
