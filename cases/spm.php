...
<head>
  ...
  <meta name="description" content="Case study: Dynamic CFD analysis of a vertical-axis washing machine with a hydraulic balancer ">
...
<!-- === SEO head (auto-generated, matches backup website_now) === -->
  <link rel="canonical" href="https://particleworks-europe.com/SPM-vertical-axis-washing-machine.html">
  ...
  <meta property="og:description" content="Case study: Dynamic CFD analysis of a vertical-axis washing machine with a hydraulic balancer ">
  <meta property="og:url" content="https://particleworks-europe.com/SPM-vertical-axis-washing-machine.html">
  <meta property="og:type" content="website">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Moving Particle Simulation: the case studies of Particleworks Europe">
  <meta name="twitter:description" content="Case study: Dynamic CFD analysis of a vertical-axis washing machine with a hydraulic balancer ">
  <!-- Iubenda -->
...
<!-- End Google Tag Manager (noscript) -->
  ...
  <section class="case-hero">
    <div class="container">
      ...
      <h1>Dynamic CFD analysis of a vertical-axis washing machine with a hydraulic balancer</h1>
      <div class="case-meta">
        <strong><i class="bi bi-people me-1"></i> Mario Cagliari &amp; Alberto Del Rizzo, SPM Engineering</strong>
        <span class="mx-2">|</span>
        <span><i class="bi bi-building me-1"></i> SPM Engineering</span>
      </div>
    </div>
  </section>
      ...
      <div class="row g-5">
        <div class="col-lg-8">
          <div class="case-image">
            <img src="../images/case-studies/spm-washing-machine.png" alt="Dynamic CFD analysis of a vertical-axis washing machine with a hydraulic balancer">
          </div>
          <h3 class="fw-bold mb-3">Abstract</h3>
          <p class="abstract-text">Study of a washing machine's hydraulic balancer behaviour using particle-based CFD methodology and multibody solver to simulate the balancer and oscillating group.</p>
        </div>
        <div class="col-lg-4">
          <div class="sidebar-card mb-4">
            ...
            <div class="d-flex align-items-center mb-3">
              ...
              <div>
                ...
                <span class="fw-medium">SPM Engineering</span>
              </div>
            </div>
            <div class="d-flex align-items-center mb-3">
              ...
              <div class="d-flex align-items-center mb-3">
                ...
                <div>
                  ...
                  <span class="fw-medium">Futurities Year 21 n&deg;2</span>
                </div>
              </div>
            <div class="d-flex align-items-center mb-3">
          ...
          <div class="sidebar-card">
            ...
            <div class="d-grid gap-2">
              ...
              <a href="https://particleworks-europe.forms-eu.com/embed.php?id=12836" class="btn btn-pw-green me-3 mb-2" target="_blank">
