...
<head>
  ...
  <meta name="description" content="Case study: Particleworks MPS method validation for oil piston cooling jets in a high-performance engine application">
...
<!-- === SEO head (auto-generated, matches backup website_now) === -->
  <link rel="canonical" href="https://particleworks-europe.com/HPECoxa_oil-pistoncooling-jets.html">
  ...
  <meta property="og:description" content="Case study: Particleworks MPS method validation for oil piston cooling jets in a high-performance engine application">
  <meta property="og:url" content="https://particleworks-europe.com/HPECoxa_oil-pistoncooling-jets.html">
  <meta property="og:type" content="website">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Moving Particle Simulation: the case studies of Particleworks Europe">
  <meta name="twitter:description" content="Case study: Particleworks MPS method validation for oil piston cooling jets in a high-performance engine application">
  <!-- Iubenda -->
...
<!-- End Google Tag Manager (noscript) -->
  ...
  <section class="case-hero">
    <div class="container">
      ...
      <h1>Particleworks MPS method validation for oil piston cooling jets in a high-performance engine application</h1>
      <div class="case-meta">
        <strong><i class="bi bi-people me-1"></i> Francesco Porta, HPE COXA</strong>
        <span class="mx-2">|</span>
        <span><i class="bi bi-building me-1"></i> HPE COXA</span>
      </div>
    </div>
  </section>
      ...
      <div class="row g-5">
        <div class="col-lg-8">
          <div class="case-image">
            <img src="../images/case-studies/HPE-COXA-img01.png" alt="Particleworks MPS method validation for oil piston cooling jets in a high-performance engine application">
          </div>
          <h3 class="fw-bold mb-3">Abstract</h3>
          <p class="abstract-text">Validation of the MPS methodology for oil piston cooling jets comparing Particleworks (MPS) against STAR CCM+ (VOF/Overset). The MPS methodology enables quick evaluation of multiple piston cooling configurations in early design stages.</p>
        </div>
        <div class="col-lg-4">
          <div class="sidebar-card mb-4">
            ...
            <div class="d-flex align-items-center mb-3">
              ...
              <div>
                ...
                <span class="fw-medium">HPE COXA</span>
              </div>
            </div>
            <div class="d-flex align-items-center mb-3">
              ...
              <div class="d-flex align-items-center mb-3">
                ...
                <div>
                  ...
                  <span class="fw-medium">International CAE Conference 2020</span>
                </div>
              </div>
            <div class="d-flex align-items-center mb-3">
          ...
          <div class="sidebar-card">
            ...
            <div class="d-grid gap-2">
              ...
              <a href="https://particleworks-europe.forms-eu.com/embed.php?id=13611" class="btn btn-pw-green me-3 mb-2" target="_blank">
