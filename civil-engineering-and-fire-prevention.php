...
<head>
  ...
  <title>Case Studies: civil engineering - Particleworks Europe</title>
  <meta name="description" content="Simulation of moving particles: discover the case studies of civil engineering. Visit our website and check out insights, application and much more!">
  ...
  <style>
    :root {
      ...
      --pw-gray: #6c757d;
      --pw-light: #f8f9fa;
      --hero-accent: linear-gradient(135deg, #bf360c 0%, #d84315 40%, #e64a19 100%);
    }
    * { font-family: 'Inter', sans-serif; }
    ...
    .app-hero::after { content: ''; position: absolute; inset: 0; background: linear-gradient(180deg, rgba(191,54,12,0.55) 0%, rgba(191,54,12,0.85) 100%); }
    .app-hero .container { position: relative; z-index: 2; }
    .app-hero .badge-industry { display: inline-flex; align-items: center; gap: 0.4rem; background: rgba(230,74,25,0.35); color: #fff; border: 1px solid rgba(230,74,25,0.6); padding: 0.3rem 0.9rem; border-radius: 50px; font-size: 0.78rem; font-weight: 700; letter-spacing: 0.5px; text-transform: uppercase; margin-bottom: 1.2rem; }
...
<!-- === SEO head (auto-generated, matches backup website_now) === -->
  <link rel="canonical" href="https://particleworks-europe.com/civil-engineering-and-fire-prevention.html">
  ...
  <meta property="og:title" content="Case Studies: civil engineering - Particleworks Europe">
  <meta property="og:description" content="Simulation of moving particles: discover the case studies of civil engineering. Visit our website and check out insights, application and much more!">
  <meta property="og:url" content="https://particleworks-europe.com/civil-engineering-and-fire-prevention.html">
  <meta property="og:type" content="website">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Case Studies: civil engineering - Particleworks Europe">
  <meta name="twitter:description" content="Simulation of moving particles: discover the case studies of civil engineering. Visit our website and check out insights, application and much more!">
  <!-- Iubenda -->
...
<!-- End Google Tag Manager (noscript) -->
        ...
        <ul class="navbar-nav align-items-lg-center gap-1">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
              ...
              <li><a class="dropdown-item active" href="civil-engineering-and-fire-prevention.html"><i class="bi bi-fire"></i><span><div class="dd-t">Civil Engineering &amp; Fire</div><div class="dd-s">Safety and infrastructure</div></span></a></li>
            </ul>
          </li>
  ...
  <section class="app-body">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-10">
          ...
          <p>Effective management of fluid, air, or dust flow is crucial for safety. Fire prevention systems, water flow in drencher systems, debris flow and tsunami simulation. These applications demand robust simulation of extreme, transient fluid events where failure is not an option.</p>

          <p>Particleworks brings the power of meshfree particle simulation to civil engineering and safety applications. From predicting concrete flowability during pouring to simulating the devastating forces of tsunami waves on structures, the method naturally handles the large deformations, free surfaces, and solid-fluid interactions that characterize these challenging scenarios.</p>

          <figure class="app-figure"><img src="images/case-studies/civil-engineering-and-fire.webp" alt="Fluid and thermal simulation for civil engineering and fire prevention" loading="lazy"><figcaption>Fluid and thermal simulation for civil engineering and fire prevention</figcaption></figure>
          ...
          <div class="row g-3 mb-4">
            <div class="col-md-4 col-sm-6">
              <div class="cap-card">
                <div class="cap-icon"><i class="bi bi-bricks"></i></div>
                <h6>Concrete flowability</h6>
              </div>
            </div>
            <div class="col-md-4 col-sm-6">
              <div class="cap-card">
                <div class="cap-icon"><i class="bi bi-cone-striped"></i></div>
                <h6>Sediment flow at excavator</h6>
              </div>
            </div>
            <div class="col-md-4 col-sm-6">
              <div class="cap-card">
                <div class="cap-icon"><i class="bi bi-tsunami"></i></div>
                <h6>Debris flow breakers</h6>
              </div>
            </div>
            <div class="col-md-4 col-sm-6">
              <div class="cap-card">
                <div class="cap-icon"><i class="bi bi-water"></i></div>
                <h6>Tsunami-induced motion</h6>
              </div>
            </div>
            <div class="col-md-4 col-sm-6">
              <div class="cap-card">
                <div class="cap-icon"><i class="bi bi-fire"></i></div>
                <h6>Fire prevention drencher systems</h6>
              </div>
            </div>
          </div>
          ...
          <div class="row g-4 mb-4">
            <div class="col-lg-6">
              <div class="video-wrap">
                <iframe src="https://www.youtube.com/embed/2QRUgJ2bKjQ?autoplay=1&mute=1&loop=1&playlist=2QRUgJ2bKjQ&controls=0&showinfo=0" title="Civil engineering simulation" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="video-wrap">
                <iframe src="https://www.youtube.com/embed/VX8tL68prnM?autoplay=1&mute=1&loop=1&playlist=VX8tL68prnM&controls=0&showinfo=0" title="Debris flow simulation" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="video-wrap">
                <iframe src="https://www.youtube.com/embed/tuHKan4Dl3g?autoplay=1&mute=1&loop=1&playlist=tuHKan4Dl3g&controls=0&showinfo=0" title="Fire prevention drencher simulation" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
            </div>
          </div>
          ...
          <div class="row g-3">
            <div class="col-md-6">
              <a href="cases/fire-simulation.html" class="case-card">
                <h5>Fire Simulation</h5>
                <span class="card-arrow"><i class="bi bi-arrow-right"></i></span>
              </a>
            </div>
            <div class="col-md-6">
              <a href="cases/zeco.html" class="case-card">
                <h5>Zeco</h5>
                <span class="card-arrow"><i class="bi bi-arrow-right"></i></span>
              </a>
            </div>
    ...
    <div class="container">
      ...
      <div class="row g-3">
            ...
            <div class="col-lg-4 col-md-6">
              <a href="civil-engineering-and-fire-prevention.html" class="app-tile current">
  ...
  <section class="cta-section">
    <div class="container text-center">
      ...
      <p style="color:var(--pw-gray); max-width:520px; margin:0 auto 1.5rem; font-size:1.05rem;">Request a personalized demo to explore civil engineering and fire prevention simulation.</p>
