...
<head>
  ...
  <meta name="description" content="Case study: Refining the design of a spout for a laundry detergent - Particleworks enables fluid flow simulation combined with human-like behavior to improve product performance">
...
<!-- === SEO head (auto-generated, matches backup website_now) === -->
  <link rel="canonical" href="https://particleworks-europe.com/LIONCorporation-Liquiddetergent.html">
  ...
  <meta property="og:description" content="Case study: Refining the design of a spout for a laundry detergent - Particleworks enables fluid flow simulation combined with human-like behavior to improve product performance">
  <meta property="og:url" content="https://particleworks-europe.com/LIONCorporation-Liquiddetergent.html">
  <meta property="og:type" content="website">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Moving Particle Simulation: the case studies of Particleworks Europe">
  <meta name="twitter:description" content="Case study: Refining the design of a spout for a laundry detergent - Particleworks enables fluid flow simulation combined with human-like behavior to improve product performance">
  <!-- Iubenda -->
...
<!-- End Google Tag Manager (noscript) -->
  ...
  <section class="case-hero">
    <div class="container">
      ...
      <h1>Refining the design of a spout for a laundry detergent</h1>
      <div class="case-meta">
        <strong><i class="bi bi-people me-1"></i> Nobuhito Nakagawa &amp; Taishi Nakamura (Lion Corporation), Akiko Kondoh (Prometech)</strong>
        <span class="mx-2">|</span>
        <span><i class="bi bi-building me-1"></i> Lion Corporation</span>
      </div>
    </div>
  </section>
      ...
      <div class="row g-5">
        <div class="col-lg-8">
          <div class="case-image">
            <img src="images/case-studies/LION_01.png" alt="Refining the design of a spout for a laundry detergent">
          </div>
          <h3 class="fw-bold mb-3">Abstract</h3>
          <p class="abstract-text">LION's Container and Packaging Engineering Research Laboratories used Particleworks with Prometech's cooperation for fluid dynamics simulation of cap design for the new HARETA brand. Previously made nearly 100 prototypes &mdash; now using scientific simulation.</p>
        </div>
        <div class="col-lg-4">
          <div class="sidebar-card mb-4">
            ...
            <div class="d-flex align-items-center mb-3">
              ...
              <div>
                ...
                <span class="fw-medium">Lion Corporation</span>
              </div>
            </div>
            <div class="d-flex align-items-center mb-3">
          ...
          <div class="sidebar-card">
            ...
            <div class="d-grid gap-2">
              <a href="images/case-studies/lion.pdf" class="btn btn-pw me-3 mb-2" target="_blank">
