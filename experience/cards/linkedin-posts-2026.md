# Particleworks Experience 2026 — LinkedIn Speaker Posts

Ready-to-publish posts, one per speaker (styled like the 2024 edition). Swap the register link for a `lnkd.in` short link if preferred.

Register link: https://particleworks-europe.com/experience/registration.php
...
Alpcan Güray from MTU Aero Engines AG will show how Particleworks models the shot peening of fatigue-critical aerospace components.

Leveraging coupled CFD-DEM simulation, the team was able to:
- Accurately predict shot trajectories from machine, nozzle and air-pressure parameters
...
Michelangelo Raimondo from the University of Modena and Reggio Emilia will present an integrated simulation approach for stator oil-jacket and jet cooling systems.

Leveraging particle simulation, the study was able to achieve:
- A coupled MPS–FVM method that restores accuracy in critical wall-flow regions
...
## 🌡️ RECIPROCATING PUMP THERMAL ANALYSIS

Leonardo Lanciotti from R&D CFD will show a conjugate-heat-transfer analysis of a reciprocating pump.

Leveraging particle simulation, the team was able to:
- Identify hot spots and verify thermal limits at the piston seals
...
Jean Decaix from HES-SO Valais//Wallis will present Moving Particle Simulation of eroded Pelton runners.

Leveraging GPU-accelerated MPS, the study was able to:
- Simulate real erosion geometries from new, mid-life and end-of-life runners
...
## ⚙️ BEARING HEAT TRANSFER

Lijun Cao and Mehul Pandya from SKF will show Particleworks capabilities for predicting heat transfer coefficients on bearing components.

Leveraging particle simulation, SKF was able to achieve:
- Quick estimation of convective HTCs coupled with SKF's BEAST tool
...
Dr. Lukas Hafner from deepfluid will show how direct optical air-in-oil measurement enables more accurate simulation of gearings and hydraulic systems.

Leveraging optical measurement and particle simulation, deepfluid was able to:
- Detect and quantify air bubbles in lubricants and hydraulic fluids
...
## 🚜 UNDERCARRIAGE ROLLER LUBRICATION

Leonardo Tiberi from Track One SRL will show a CFD 3D-MPS study of carrier-roller lubrication.

Leveraging particle simulation, Track One was able to:
- Model the lubricant behaviour inside the roller layout under field conditions
...
Naohiro Fujita from Univance Corporation will show how Particleworks supports gear lubrication analysis and its expansion to R&D on airflow effects.

Leveraging particle simulation, Univance was able to:
- Capture complex oil splashing and churning in the early design stage
...
René Kockisch from IAV GmbH will show air-bubble dynamics in the gear oil of an electric 3-speed commercial-vehicle drivetrain.

Leveraging the IAV Particle Explorer and high-speed imaging, the team was able to:
- Quantify bubble formation, transport, coalescence and dissolution
