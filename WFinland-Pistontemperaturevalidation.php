...
<head>
  ...
  <meta name="description" content="Case study: Designing and analysing the cooling of a medium speed engine piston using MPS method">
...
<!-- === SEO head (auto-generated, matches backup website_now) === -->
  <link rel="canonical" href="https://particleworks-europe.com/WFinland-Pistontemperaturevalidation.html">
  ...
  <meta property="og:description" content="Case study: Designing and analysing the cooling of a medium speed engine piston using MPS method">
  <meta property="og:url" content="https://particleworks-europe.com/WFinland-Pistontemperaturevalidation.html">
  <meta property="og:type" content="website">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Moving Particle Simulation: the case studies of Particleworks Europe">
  <meta name="twitter:description" content="Case study: Designing and analysing the cooling of a medium speed engine piston using MPS method">
  <!-- Iubenda -->
...
<!-- End Google Tag Manager (noscript) -->
  ...
  <section class="case-hero">
    <div class="container">
      ...
      <h1>Designing and analysing the cooling of a medium speed engine piston using MPS method</h1>
      <div class="case-meta">
        <strong><i class="bi bi-people me-1"></i> Sami Ojala, W&auml;rtsil&auml; Finland Oy</strong>
        <span class="mx-2">|</span>
        <span><i class="bi bi-building me-1"></i> W&auml;rtsil&auml; Finland Oy</span>
      </div>
    </div>
  </section>
      ...
      <div class="row g-5">
        <div class="col-lg-8">
          <div class="case-image">
            <img src="images/case-studies/SamiOjala_01.png" alt="Designing and analysing the cooling of a medium speed engine piston using MPS method">
          </div>
          <h3 class="fw-bold mb-3">Abstract</h3>
          <p class="abstract-text">Oil splashing inside piston is a free surface flow difficult to simulate. Particleworks with MPS method offers an effective way to simulate oil flow and calculate heat transfer coefficient. Quick evaluation of different designs without long pre-processing.</p>
        </div>
        <div class="col-lg-4">
          <div class="sidebar-card mb-4">
            ...
            <div class="d-flex align-items-center mb-3">
              ...
              <div>
                ...
                <span class="fw-medium">W&auml;rtsil&auml; Finland Oy</span>
              </div>
            </div>
            <div class="d-flex align-items-center mb-3">
              ...
              <div class="d-flex align-items-center mb-3">
                ...
                <div>
                  ...
                  <span class="fw-medium">International CAE Conference 2018</span>
                </div>
              </div>
            <div class="d-flex align-items-center mb-3">
          ...
          <div class="sidebar-card">
            ...
            <div class="d-grid gap-2">
              <a href="images/case-studies/CAE2018_Wartsila_piston_cooling_validation_paper_0.pdf" class="btn btn-pw me-3 mb-2" target="_blank">
