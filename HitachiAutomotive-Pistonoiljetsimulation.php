...
<head>
  ...
  <meta name="description" content="Case study: Piston oil jet simulation">
...
<!-- === SEO head (auto-generated, matches backup website_now) === -->
  <link rel="canonical" href="https://particleworks-europe.com/HitachiAutomotive-Pistonoiljetsimulation.html">
  ...
  <meta property="og:description" content="Case study: Piston oil jet simulation">
  <meta property="og:url" content="https://particleworks-europe.com/HitachiAutomotive-Pistonoiljetsimulation.html">
  <meta property="og:type" content="website">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Moving Particle Simulation: the case studies of Particleworks Europe">
  <meta name="twitter:description" content="Case study: Piston oil jet simulation">
  <!-- Iubenda -->
...
<!-- End Google Tag Manager (noscript) -->
  ...
  <section class="case-hero">
    <div class="container">
      ...
      <h1>Piston oil jet simulation</h1>
      <div class="case-meta">
        <strong><i class="bi bi-people me-1"></i> Yuki Takahashi, Hitachi Automotive Systems</strong>
        <span class="mx-2">|</span>
        <span><i class="bi bi-building me-1"></i> Hitachi Automotive Systems</span>
      </div>
    </div>
  </section>
      ...
      <div class="row g-5">
        <div class="col-lg-8">
          <div class="case-image">
            <img src="images/case-studies/piston_hitachi01_0.png" alt="Piston oil jet simulation">
          </div>
          <h3 class="fw-bold mb-3">Abstract</h3>
          <p class="abstract-text">Hitachi Automotive Systems used Particleworks to evaluate piston cooling performance effectively.</p>
        </div>
        <div class="col-lg-4">
          <div class="sidebar-card mb-4">
            ...
            <div class="d-flex align-items-center mb-3">
              ...
              <div>
                ...
                <span class="fw-medium">Hitachi Automotive Systems</span>
              </div>
            </div>
            <div class="d-flex align-items-center mb-3">
              ...
              <div class="d-flex align-items-center mb-3">
                ...
                <div>
                  ...
                  <span class="fw-medium">Prometech Simulation Conference 2019</span>
                </div>
              </div>
            <div class="d-flex align-items-center mb-3">
          ...
          <div class="sidebar-card">
            ...
            <div class="d-grid gap-2">
              <a href="images/case-studies/userinterview_hitachiautomotive.pdf" class="btn btn-pw me-3 mb-2" target="_blank">
    ...
    <section class="quote-section">
      <div class="container text-center">
        <blockquote>
          ...
          &ldquo;By using Particleworks we were able to evaluate the cooling performance of the piston effectively, which we had not been able to simulate well before&rdquo;
        </blockquote>
        <cite class="d-block mt-3">&mdash; Yuki Takahashi</cite>
      </div>
    </section>
  <footer>
    <div class="container">
