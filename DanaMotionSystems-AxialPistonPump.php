...
<head>
  ...
  <meta name="description" content="Case study: Churning Losses Evaluation in Swashplate Axial Piston Pump using Moving Particle Approach">
...
<!-- === SEO head (auto-generated, matches backup website_now) === -->
  <link rel="canonical" href="https://particleworks-europe.com/DanaMotionSystems-AxialPistonPump.html">
  ...
  <meta property="og:description" content="Case study: Churning Losses Evaluation in Swashplate Axial Piston Pump using Moving Particle Approach">
  <meta property="og:url" content="https://particleworks-europe.com/DanaMotionSystems-AxialPistonPump.html">
  <meta property="og:type" content="website">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Moving Particle Simulation: the case studies of Particleworks Europe">
  <meta name="twitter:description" content="Case study: Churning Losses Evaluation in Swashplate Axial Piston Pump using Moving Particle Approach">
  <!-- Iubenda -->
...
<!-- End Google Tag Manager (noscript) -->
  ...
  <section class="case-hero">
    <div class="container">
      ...
      <h1>Churning Losses Evaluation in Swashplate Axial Piston Pump using Moving Particle Approach</h1>
      <div class="case-meta">
        <strong><i class="bi bi-people me-1"></i> Francesco Canestri &amp; A. Lucchi (Dana Motion Systems), G. Parma &amp; M. Galbiati (EnginSoft)</strong>
        <span class="mx-2">|</span>
        <span><i class="bi bi-building me-1"></i> Dana Motion Systems</span>
      </div>
    </div>
  </section>
      ...
      <div class="row g-5">
        <div class="col-lg-8">
          <div class="case-image">
            <img src="images/case-studies/DanaMotion_01.png" alt="Churning Losses Evaluation in Swashplate Axial Piston Pump using Moving Particle Approach">
          </div>
          <h3 class="fw-bold mb-3">Abstract</h3>
          <p class="abstract-text">In axial piston units, churning losses have a non-negligible influence on mechanical efficiency. This work presents a numerical approach for the evaluation of churning losses using MPS software Particleworks. A sensitivity analysis evaluates the influence of particle size, slip factor and turbulence model.</p>
        </div>
        <div class="col-lg-4">
          <div class="sidebar-card mb-4">
            ...
            <div class="d-flex align-items-center mb-3">
              ...
              <div>
                ...
                <span class="fw-medium">Dana Motion Systems</span>
              </div>
            </div>
            <div class="d-flex align-items-center mb-3">
          ...
          <div class="sidebar-card">
            ...
            <div class="d-grid gap-2">
              <a href="images/case-studies/CAE2019_DANA_Axial-pump.pdf" class="btn btn-pw me-3 mb-2" target="_blank">
