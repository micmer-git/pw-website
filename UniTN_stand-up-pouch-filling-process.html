...
<head>
  ...
  <meta name="description" content="Case study: Flexible stand-up pouch filling process analysis by Coupling Particle-Based CFD and Multi-Flexible Body Dynamics Simulation">
...
<!-- === SEO head (auto-generated, matches backup website_now) === -->
  <link rel="canonical" href="https://particleworks-europe.com/UniTN_stand-up-pouch-filling-process.html">
  ...
  <meta property="og:description" content="Case study: Flexible stand-up pouch filling process analysis by Coupling Particle-Based CFD and Multi-Flexible Body Dynamics Simulation">
  <meta property="og:url" content="https://particleworks-europe.com/UniTN_stand-up-pouch-filling-process.html">
  <meta property="og:type" content="website">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Moving Particle Simulation: the case studies of Particleworks Europe">
  <meta name="twitter:description" content="Case study: Flexible stand-up pouch filling process analysis by Coupling Particle-Based CFD and Multi-Flexible Body Dynamics Simulation">
  <!-- Iubenda -->
...
<!-- End Google Tag Manager (noscript) -->
  ...
  <section class="case-hero">
    <div class="container">
      ...
      <h1>Flexible stand-up pouch filling process analysis by Coupling Particle-Based CFD and Multi-Flexible Body Dynamics</h1>
      <div class="case-meta">
        <strong><i class="bi bi-people me-1"></i> Matteo Berlato, University of Trento</strong>
        <span class="mx-2">|</span>
        <span><i class="bi bi-building me-1"></i> University of Trento</span>
      </div>
    </div>
  </section>
      ...
      <div class="row g-5">
        <div class="col-lg-8">
          <div class="case-image">
            <img src="images/case-studies/Coesia_UniTN.png" alt="Flexible stand-up pouch filling process analysis by Coupling Particle-Based CFD and Multi-Flexible Body Dynamics">
          </div>
          <h3 class="fw-bold mb-3">Abstract</h3>
          <p class="abstract-text">Flexible stand-up pouch filling process modeled using coupled Particleworks (MPS CFD) and RecurDyn (Multi-Flexible Body Dynamics). Two-way coupling for accurate fluid-flexible boundary interaction.</p>
        </div>
        <div class="col-lg-4">
          <div class="sidebar-card mb-4">
            ...
            <div class="d-flex align-items-center mb-3">
              ...
              <div>
                ...
                <span class="fw-medium">University of Trento</span>
              </div>
            </div>
            <div class="d-flex align-items-center mb-3">
              ...
              <div class="d-flex align-items-center mb-3">
                ...
                <div>
                  ...
                  <span class="fw-medium">Newsletter EnginSoft Year 18 n&deg;3</span>
                </div>
              </div>
            <div class="d-flex align-items-center mb-3">
          ...
          <div class="sidebar-card">
            ...
            <div class="d-grid gap-2">
              ...
              <a href="https://particleworks-europe.forms-eu.com/embed.php?id=13892" class="btn btn-pw-green me-3 mb-2" target="_blank">
