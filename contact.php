...
<!-- === SEO head (auto-generated, matches backup website_now) === -->
  <link rel="canonical" href="https://particleworks-europe.com/contact.html">
  ...
  <meta property="og:url" content="https://particleworks-europe.com/contact.html">
...
<body>
    ...
    <!-- banner title -->
      <section class="main_section background-blue">
          <div class="container">
              <div class="row">
                  <div class="col-12">
                      <h1 class="display-6 text-end text-uppercase text-white pt-2">Contact us</h1>
                  </div></div></div>
              </section>
 ...
 <div id="mf_placeholder" 
     data-formurl="https://particleworks-europe.forms-eu.com/embed.php?id=22527" 
     data-formheight="791"  
...
<script>
	(function(f,o,r,m){
       ...
       <div class="col-md-5 background_gray pt-4 px-4 map-w_bg">
           <h2 class="featurette-heading">Send Us <span class="text-muted">a Message</span></h2>
           <p class="lead pt-4">Contact us or give us a call to discover how we can help</p>

<h6 class="text-blue">Particleworks Europe</h6>
<p><i class="bi bi-geo-alt"></i> <strong>Address:</strong> Via della Stazione 27, Fraz. Mattarello - 38123 Trento - Italy<br>
	<i class="bi bi-telephone"></i> <strong>Phone:</strong> +39 0461 915391<br>
	<i class="bi bi-envelope"></i> <strong>Email:</strong> <a href="mailto:info@particleworks-europe.com" class="underline">info@particleworks-europe.com</a>
           </p>
           
           <hr class="featurette-divider">

           <h4 class="featurette-heading">Resellers</h4>

           <p>Our network of international resellers serve all countries: <a href="resellers.html" class="underline">see the complete list</a>.</p>
           <div class="row row-cols-3 d-flex align-items-center justify-content-center g-2 py-4">  
